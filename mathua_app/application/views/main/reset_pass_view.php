        	  ...
        	  <div class="container">
	            ...
	            <div class="row">
	            	<div class="col-sm-12 text-center">
						<h1 class="header_search"> Reset Password</h1><br/>
						<?php if(isset($error)) :?>
				...
				<form class="form-horizontal" method="POST">
					...
					<div class="form-group">
					  <label class="control-label col-sm-12" for="user_mobile">New Password:</label>
					  <div class="col-sm-12">
						<input type="password" class="form-control" id="user_pass" placeholder="Enter Password" name="user_pass" required="" autocomplete="off">
						<small class="text-error"><?php echo form_error('user_pass');?></small>
					  </div>
					</div>
					<div class="form-group">
					  <label class="control-label col-sm-12" for="user_mobile">Re-Enter Password:</label>
					  <div class="col-sm-12">
						<input type="password" class="form-control" id="user_repass" placeholder="Re-Enter Password" name="user_repass" required="" autocomplete="off">
						<small class="text-error"><?php echo form_error('user_repass');?></small>
					  </div>
					</div>
