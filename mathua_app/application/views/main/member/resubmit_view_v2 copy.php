		...
		<div class="step-content">
			...
			<div data-step="step1">
				...
				<div class="row">
					...
					<div class="col-sm-6 pr-0"> <strong>Applied For :</strong> <?php echo $adv_detail->adv_no . ' | Recrutment For - ' . $adv_detail->rm_name; ?></div>

					<div class="col-sm-6 pr-0"><strong>Full Name :</strong> <?php echo $fuser_detailset->f_full_name; ?></div>

				</div>

				<div class="row mt-3">

					<div class="col-sm-6 pr-0"><strong>Mobile No : </strong><?php echo $fuser_detailset->f_mobile; ?></div>

					<div class="col-sm-6 pr-0"><strong>Email : </strong><?php echo $fuser_detailset->f_email; ?></div>

				</div>

				<div class="row mt-3">

					<div class="col-sm-6 pr-0"><strong>Discipline : </strong> <?php echo $adv_category->catm_name; ?></div>
					...
					<div class="row mt-3">
						...
						<div class="col-sm-10">
								...
								<?php foreach ($caste_tab as $caste) : ?>
									...
									<input type='radio' id='acc' name='fu_caste_type' value="<?= $caste->caste_id ?>" <?php if ($fuser_detailset->fu_caste_type == $caste->caste_id) echo 'checked'; ?> onchange="yesnoCheck();"> <?= $caste->caste_name ?>
			...
			<div data-step="step4">
								...
								<div class="col-sm-12">
									<table class="table">
										...
										<?php $secarr = (array)$quali_list;
											...
											<tr>
												<td>
												<input type="hidden" id="examid_<?php echo $q; ?>" name="examid_<?php echo $q; ?>" value="<?php echo $secarr[$q]->fu_quali_id; ?>" />
												...
												<td>
													<input type="text" class="form-control univ-input" id="univ_<?php echo $q; ?>" name="univ_<?php echo $q; ?>" placeholder="Enter Name" value="<?php if(!empty($secarr[$q]->fu_council_board)){echo $secarr[$q]->fu_council_board;} ?>" />
													<small class="text-error univ_<?php echo $q; ?>"><?php echo form_error('univ_'.$q); ?></small>
												</td>
												<td>
													<select class="form-control state-input" name="state_<?php echo $q; ?>" id="state_<?php echo $q; ?>">
														<option value="">---Select---</option>
														<?php foreach ($state_list as $states) { ?>
												...
												<td>
													<input type="text" class="form-control marks-obtained-input" name="marks_obtained_<?php echo $q; ?>" id="marks_obtained_<?php echo $q; ?>" placeholder="Marks Obtained" onkeyup="percentcheck_exm();" value="<?php if(!empty($secarr[$q]->fu_marks_obtained)){echo $secarr[$q]->fu_marks_obtained;} ?>" />
													<small class="text-error marks_obtained_<?php echo $q; ?>"><?php echo form_error('marks_obtained_'.$q); ?></small>
												</td>
												<td>
													<input type="text" class="form-control marks-full-input" id="marks_full_<?php echo $q; ?>" name="marks_full_<?php echo $q; ?>" placeholder="Full Marks" onkeyup="percentcheck_exm();" value="<?php if(!empty($secarr[$q]->fu_full_marks)){echo $secarr[$q]->fu_full_marks;} ?>" />
												...
												<td>
													<select class="form-control state-input" name="add_attempt_<?php echo $q; ?>" id="add_attempt_<?php echo $q; ?>">
												...
												<td>
													<input type="file" name="marksheet_<?php echo $q; ?>" id="marksheet_<?php echo $q; ?>" class="form-control marksheet">
									...
									<table class="table">
										...
										<tbody>
											<tr>
												...
												<td>
													<input type="text" class="form-control" id="exp_org" name="exp_org" placeholder="Organization Name" />
													<small class="text-error exp_org"><?php echo form_error('exp_org'); ?></small>
												</td>
												<td width="10%">
													<input type="text" class="form-control" id="exp_year" name="exp_year" placeholder="Year" />
													<small class="text-error exp_year"><?php echo form_error('exp_year'); ?></small>
												</td>
												<td width="10%">
													<input type="text" class="form-control" id="exp_month" name="exp_month" placeholder="Month" />
													<small class="text-error exp_month"><?php echo form_error('exp_month'); ?></small>
												</td>
												<td>
													<input type="file" name="exp_docs" id="exp_docs" class="form-control" />
					...
					<div class="row mt-5">
						...
						<div class="col-sm-12 text-center">
							...
							<button class="btn btn-primary step-btn button_submit" onclick="all_resubmit_step();">Submit</button>
...
<script type="text/javascript">
	...
	<?php if (($fuser_detailset->fu_step_1 == 1) && ($fuser_detailset->fu_step_3 == 0 || $fuser_detailset->fu_step_3 == 2)) { ?>
	...
	<?php if (($fuser_detailset->fu_step_1 == 1 && $fuser_detailset->fu_step_3 == 1)) { ?>
		...
		function all_resubmit_step() {

			alert('Final reached');exit;
