			...
			<div class="step-tab-panel" data-step="step2">
				...
				<div class="row">
					...
					<div class="col-sm-4">
						...
						<input type="text" class="form-control" data-toggle="tooltip" data-placement="top" title="Please enter your father's name" placeholder="Father's Name" id="father_name" name="father_name" autocomplete="off" <?php if ($fuser_detailset->fu_step_2 == 1) {
																																																											echo "readonly";
																																																										} ?> value="<?= $fuser_detailset->fu_father_name ?>" />
					...
					<div class="col-sm-4">
						...
						<input type="text" class="form-control" data-toggle="tooltip" data-placement="top" title="Please enter your mother's name" placeholder="Mother's Name" id="mother_name" name="mother_name" autocomplete="off" <?php if ($fuser_detailset->fu_step_2 == 1) {
																																																											echo "readonly";
																																																										} ?> value="<?= $fuser_detailset->fu_mother_name ?>" />
				...
				<div class="row mt-3">
					...
					<div class="col-sm-4">
						...
						<label class="radio-inline"><input type="radio" name="fu_gender" id="fu_gender_1" autocomplete="off" value="Male" <?php if ($fuser_detailset->fu_gender == "Male") echo "checked" ?> <?php if ($fuser_detailset->fu_step_2 == 1) {
																																																				echo "disabled";
																																																			} ?> /> Male</label>

						<label class="radio-inline"><input type="radio" name="fu_gender" id="fu_gender_2" autocomplete="off" value="Female" <?php if ($fuser_detailset->fu_gender == "Female") echo "checked" ?> <?php if ($fuser_detailset->fu_step_2 == 1) {
																																																					echo "disabled";
																																																				} ?> /> Female</label>

						<label class="radio-inline"><input type="radio" name="fu_gender" id="fu_gender_3" autocomplete="off" value="Others" <?php if ($fuser_detailset->fu_gender == "Others") echo "checked" ?> <?php if ($fuser_detailset->fu_step_2 == 1) {
																																																					echo "disabled";
																																																				} ?> /> Others</label><br>
					...
					<div class="col-sm-4">
						...
						<input type="date" class="form-control" name="fu_dob" id="fu_dob" autocomplete="off" <?php if ($fuser_detailset->fu_step_2 == 1) {
																													echo "readonly";
																												} ?> value="<?= $fuser_detailset->fu_dob ?>" />
				...
				<div class="row mt-3">
					...
					<div class="col-sm-4">
						...
						<label class="radio-inline"><input type="radio" name="fu_mt_status" id="fu_mt_status_1" autocomplete="off" value="Single" <?php if ($fuser_detailset->fu_marital_status == "Single") echo "checked" ?> <?php if ($fuser_detailset->fu_step_2 == 1) {
																																																									echo "disabled";
																																																								} ?> /> Single</label>

						<label class="radio-inline"><input type="radio" name="fu_mt_status" id="fu_mt_status_2" autocomplete="off" <?php if ($fuser_detailset->fu_marital_status == "Married") echo "checked" ?> value="Married" <?php if ($fuser_detailset->fu_step_2 == 1) {
																																																									echo "disabled";
																																																								} ?> /> Married</label>

						<label class="radio-inline"><input type="radio" name="fu_mt_status" id="fu_mt_status_3" autocomplete="off" <?php if ($fuser_detailset->fu_marital_status == "Widow") echo "checked" ?> value="Widow" <?php if ($fuser_detailset->fu_step_2 == 1) {
																																																								echo "disabled";
																																																							} ?> /> Widow</label>

						<label class="radio-inline"><input type="radio" name="fu_mt_status" id="fu_mt_status_4" autocomplete="off" <?php if ($fuser_detailset->fu_marital_status == "Divorced") echo "checked" ?> value="Divorced" <?php if ($fuser_detailset->fu_step_2 == 1) {
																																																										echo "disabled";
																																																									} ?> /> Divorced</label><br>
					...
					<div class="col-sm-4">
						...
						<textarea class="form-control" name="fu_address" id="fu_address" rows="3" autocomplete="off" <?php if ($fuser_detailset->fu_step_2 == 1) {
																															echo "readonly";
																														} ?>><?= $fuser_detailset->fu_address ?></textarea>
				...
				<div class="row mt-3">
					...
					<div class="col-sm-4">
						...
						<select class="form-control" name="fu_district" id="fu_district" autocomplete="off" <?php if ($fuser_detailset->fu_step_2 == 1) {
																												echo "disabled";
																											} ?>>
							...
							<?php if ($fuser_detailset->fu_step_2 != 1) { ?>
								...
								<?php foreach ($dist_list as $dists) { ?>
									...
									<option value="<?php echo $dists->district_id; ?>" <?php if (!empty($fuser_detailset->fu_district)) {
																							if ($dists->district_id == $fuser_detailset->fu_district) {
																								echo "selected";
																							}
					...
					<div class="col-sm-4">
						...
						<select class="form-control" name="fu_dom_state" id="fu_dom_state" autocomplete="off" <?php if ($fuser_detailset->fu_step_2 == 1) {
																													echo "disabled";
																												} ?>>
							...
							<?php if ($fuser_detailset->fu_step_2 != 1) { ?>
								...
								<?php foreach ($state_list as $states) { ?>
									...
									<option value="<?php echo $states->state_id; ?>" <?php if (!empty($fuser_detailset->fu_domicile_state)) {
																							if ($states->state_id == $fuser_detailset->fu_domicile_state) {
																								echo "selected";
																							}
				...
				<div class="row mt-3">
					...
					<div class="col-sm-4">
						...
						<input type="file" name="fu_pic_doc" id="fu_pic_doc" class="form-control" autocomplete="off" <?php if ($fuser_detailset->fu_step_2 == 1) {
																															echo "disabled";
																														} ?> />
				...
				<div class="row mt-3">
					...
					<div class="col-sm-4">
						...
						<input type="file" name="fu_dob_doc" id="fu_dob_doc" class="form-control" autocomplete="off" <?php if ($fuser_detailset->fu_step_2 == 1) {
																															echo "disabled";
																														} ?> />
						<small class="">File format should be in .png/.jpg/.jpeg/.pdf format</small>
						<small class="">Maximum file size is 2 MB </small>
			...
			<div class="step-tab-panel" data-step="step3">
				...
				<div class="row mt-3">
					...
					<div class="col-sm-10"> Yes
						...
						<input type="radio" onclick="javascript:yesnoCheck();" name="yesno_caste" id="yesCheck" <?php if ($fuser_detailset->fu_step_3 == 1) {
																													echo "disabled";
																												} ?> <?php if ($fuser_detailset->fu_caste == 'Yes') echo 'checked' ?> value="Yes"> No



						<input type="radio" onclick="javascript:yesnoCheck();" name="yesno_caste" id="noCheck" <?php if ($fuser_detailset->fu_step_3 == 1) {
																													echo "disabled";
																												} ?> <?php if ($fuser_detailset->fu_caste == 'No') echo 'checked' ?> value="No">

						<br>

						<small class="text-error fu_caste"><?php echo form_error('yesno_caste'); ?></small>

						<div id="ifYes" <?php if ($fuser_detailset->fu_caste == 'Yes') echo 'style="display:block"';
										else echo 'style="display:none"'; ?>>

							<?php foreach ($caste_tab as $caste) : ?>

								<input type='radio' id='acc' name='fu_caste_type' value="<?= $caste->caste_id ?>" <?php if ($fuser_detailset->fu_caste_type == $caste->caste_id) echo 'checked' ?> <?php if ($fuser_detailset->fu_step_3 == 1) {
																																																		echo "disabled";
																																																	} ?>> <?= $caste->caste_name ?>
							...
							<div class="row mt-2">
								...
								<div class="col-sm-4">
									...
									<input type="date" class="form-control" name="fu_caste_issue_date" value="<?= $fuser_detailset->fu_caste_issue_date ?>" <?php if ($fuser_detailset->fu_step_3 == 1) {
																																								echo "readonly";
																																							} ?>>
								...
								<div class="col-sm-4">
									...
									<input type="file" name="fu_caste_doc" class="form-control" <?php if ($fuser_detailset->fu_step_3 == 1) {
																									echo "disabled";
																								} ?>>
				...
				<?php if ($adv_detail->adv_has_exampted == "Yes") { ?>
					...
					<div class="row mt-3">
						...
						<div class="col-sm-10"> Yes
							...
							<input type="radio" onclick="javascript:yesnoCheck3();" name="yesno_exempted" id="yesCheck3" <?php if ($fuser_detailset->fu_step_3 == 1) {
																																echo "disabled";
																															} ?> <?php if ($fuser_detailset->fu_exempted == 'Yes') echo 'checked' ?> value="Yes"> No



							<input type="radio" onclick="javascript:yesnoCheck3();" name="yesno_exempted" id="noCheck3" <?php if ($fuser_detailset->fu_step_3 == 1) {
																															echo "disabled";
																														} ?> <?php if ($fuser_detailset->fu_exempted == 'No') echo 'checked' ?> value="No"><br>
							...
							<div class="row mt-2" id="ifyesexem" <?php if ($fuser_detailset->fu_exempted == 'Yes') echo 'style="display:block"';
								...
								<div class="row pl-2">
									...
									<div class="col-sm-4">
										...
										<select class="form-control" rows="3" name="fu_exc_reason" id="reason" <?php if ($fuser_detailset->fu_step_3 == 1) {
																													echo "disabled";
																												} ?>>
									...
									<div class="col-sm-3">
										...
										<input type="file" name="fu_exc_doc" class="form-control" <?php if ($fuser_detailset->fu_step_3 == 1) {
																										echo "disabled";
																									} ?>>
				...
				<?php if ($adv_detail->adv_has_exservice == "Yes") { ?>
					...
					<div class="row mt-3">
						...
						<div class="col-sm-10"> Yes
							...
							<input type="radio" onclick="javascript:yesnoCheck4();" name="yesno_exservice" id="yesCheck4" <?php if ($fuser_detailset->fu_step_3 == 1) {
																																echo "disabled";
																															} ?> <?php if ($fuser_detailset->fu_exservice == 'Yes') echo 'checked' ?> value="Yes"> No



							<input type="radio" onclick="javascript:yesnoCheck4();" name="yesno_exservice" id="noCheck4" <?php if ($fuser_detailset->fu_step_3 == 1) {
																																echo "disabled";
																															} ?> <?php if ($fuser_detailset->fu_exservice == 'No') echo 'checked' ?> value="No"><br>
							...
							<div class="row mt-2" id="ifyesex" <?php if ($fuser_detailset->fu_exservice == 'Yes') echo 'style="display:block"';
								...
								<div class="row pl-2">
									...
									<div class="col-sm-4">
										...
										<select class="form-control" rows="3" id="reason" name="fu_exs_reason" <?php if ($fuser_detailset->fu_step_3 == 1) {
																													echo "disabled";
																												} ?>>
			...
			<div class="step-tab-panel" data-step="step4">
					...
					<div class="row ">
						...
						<div class="col">
							...
							<div class="row pl-2 pr-2 ">
								...
								<select class="form-control exam-name-input" name="exam_name" id="exampleFormControlSelect1" <?php if ($fuser_detailset->fu_step_4 == 1) {
																																	echo "disabled";
																																} ?>>
						...
						<div class="col">
							...
							<div class="row  pl-2 pr-2"><input type="text" class="form-control univ-input" name="univ" <?php if ($fuser_detailset->fu_step_4 == 1) {
																															echo "readonly";
																														} ?>></div>
						...
						<div class="col">
							...
							<div class="row  pl-2 pr-2">
								...
								<select class="form-control state-input" name="state" <?php if ($fuser_detailset->fu_step_4 == 1) {
																							echo "disabled";
																						} ?>>
						...
						<div class="col">
							...
							<div class="row  pl-2 pr-2">
								...
								<input type="text" class="form-control marks-obtained-input" name="marks_obtained" <?php if ($fuser_detailset->fu_step_4 == 1) {
																														echo "readonly";
																													} ?>>
							</div>
						...
						<div class="col">
							...
							<div class="row  pl-2 pr-2"><input type="text" class="form-control marks-full-input" name="marks_full" <?php if ($fuser_detailset->fu_step_4 == 1) {
																																		echo "readonly";
																																	} ?>></div>
						...
						<div class="col">
							...
							<div class="row  pl-2 pr-2">
								...
								<input type="date" class="form-control marksheet-issue-date" name="marksheet_issue_date" <?php if ($fuser_detailset->fu_step_4 == 1) {
																																echo "readonly";
																															} ?>>
							</div>
						...
						<div class="col">
							...
							<div class="row  pl-2 pr-2"><input type="file" name="marksheet" class="form-control marksheet" <?php if ($fuser_detailset->fu_step_4 == 1) {
																																echo "disabled";
																															} ?>></div>
				...
				<div class="row mt-3">
					...
					<div class="col-sm-10"> Yes
						...
						<input type="radio" onclick="javascript:yesnoCheck6();" name="service_yesno" id="yesCheck6" <?php if ($fuser_detailset->fu_step_4 == 1) {
																														echo "disabled";
																													} ?> <?php if ($fuser_detailset->fu_has_service == 'Yes') echo "checked" ?> value="Yes"> No

						<input type="radio" onclick="javascript:yesnoCheck6();" name="service_yesno" id="noCheck4" <?php if ($fuser_detailset->fu_step_4 == 1) {
																														echo "disabled";
																													} ?> <?php if ($fuser_detailset->fu_has_service == 'No') echo "checked" ?> value="No">
						...
						<div class="row mt-2" id="ifyesservice" style="display:none;">
							...
							<div class="row pl-2">
								...
								<div class="col-sm-4"> <label class="radio-inline">
										...
										<input type="radio" name="fu_current_gov_service" <?php if ($fuser_detailset->fu_step_4 == 1) {
																								echo "disabled";
																							} ?> <?php if ($fuser_detailset->fu_current_gov_service == 'Yes') echo "checked" ?> value="Yes"> Yes
									...
									<label class="radio-inline">
										...
										<input type="radio" name="fu_current_gov_service" <?php if ($fuser_detailset->fu_step_4 == 1) {
																								echo "disabled";
																							} ?> <?php if ($fuser_detailset->fu_current_gov_service == 'No') echo "checked" ?> value="No"> No
							...
							<div class="row mt-2">
								...
								<div class="row pl-4">
									...
									<div class="col-sm-3">
										...
										<input type="text" name="fu_service_designation" <?php if ($fuser_detailset->fu_step_4 == 1) {
																								echo "readonly";
																							} ?> class="form-control" value=<?= $fuser_detailset->fu_service_designation ?>>
									...
									<div class="col-sm-2">
										...
										<input type="text" name="fu_service_exp_year" class="form-control" <?php if ($fuser_detailset->fu_step_4 == 1) {
																												echo "readonly";
																											} ?> placeholder="Year" value="<?= $fuser_detailset->fu_service_exp_year ?>" style="margin-left:30px;">
									...
									<div class="col-sm-2">
										...
										<input type="text" name="fu_service_exp_month" class="form-control" placeholder="Month" style="margin-left:5px;" <?php if ($fuser_detailset->fu_step_4 == 1) {
																																								echo "readonly";
																																							} ?> value="<?= $fuser_detailset->fu_service_exp_month ?>">
							...
							<div class="col-sm-12 mt-2">
								...
								<div class="row ">
									...
									<div class="col-sm-2 p-0">
										...
										<input type="text" <?php if ($fuser_detailset->fu_step_4 == 1) {
																echo "readonly";
															} ?> name="fu_total_gov_exp_year" class="form-control" placeholder="year" value="<?= $fuser_detailset->fu_toal_gov_exp_year ?>">
									...
									<div class="col-sm-2">
										...
										<input type="text" <?php if ($fuser_detailset->fu_step_4 == 1) {
																echo "readonly";
															} ?> name="fu_total_gov_exp_month" class="form-control" placeholder="month" value="<?= $fuser_detailset->fu_toal_gov_exp_month ?>">
									...
									<div class="col-sm-3 fu_gov_exp_doc_div">
										...
										<input type="file" name="fu_gov_exp_doc" class="form-control" placeholder="month" <?php if ($fuser_detailset->fu_step_4 == 1) {
																																echo "disabled";
																															} ?>>
							...
							<div class="col-sm-12 mt-4">
								...
								<div class="row ">
									...
									<div class="col-sm-2 p-0">
										...
										<input type="text" <?php if ($fuser_detailset->fu_step_4 == 1) {
																echo "readonly";
															} ?> name="fu_total_nongov_exp_year" class="form-control" placeholder="year" value="<?= $fuser_detailset->fu_toal_nongov_exp_year ?>">
									...
									<div class="col-sm-2">
										...
										<input type="text" <?php if ($fuser_detailset->fu_step_4 == 1) {
																echo "readonly";
															} ?> name="fu_total_nongov_exp_month" class="form-control" placeholder="month" value="<?= $fuser_detailset->fu_toal_nongov_exp_month ?>">
									...
									<div class="col-sm-3 fu_nongov_exp_doc_div">
										...
										<input type="file" name="fu_nongov_exp_doc" class="form-control" placeholder="month" <?php if ($fuser_detailset->fu_step_4 == 1) {
																																	echo "disabled";
																																} ?>>
...
<!--<script src="<?php //echo base_url(); 
					?>frontend/js/jquery.validate.min.js"></script>-->
			...
			$.ajax({
				...
				success: function(data) {
...

					{
						...
						setTimeout(function() {
							$('.get_error_qualification_4').fadeOut();
						}, delay);
