...
<div class="container mt-3">
	...
	<div class="row">
		...
		<div class="col-sm-12" style="margin:30px 0;">
			...
			<?php if ($fuser_detailset->fu_final_submit != 1) { ?><h5>Complete Your Form Submission below -</h5>
	...
	<div class="step-app" id="demo">
		...
		<div class="step-content">
			...
			<div class="step-tab-panel" data-step="step1">
				...
				<?php if(!empty($old_detail)){ ?>
					<div class="row">
						<div class="col-sm-12 mb-4" style="background-color: #cfffff;">
							<h5 style="color:blue">Old Data:-</h5>
							<table class="table" width="100%">
								<tr>
									<td><strong>Name : </strong></td>
									<td><?php echo $old_detail->Name; ?></td>
									<td><strong>Mobile : </strong></td>
									<td><?php echo $old_detail->Mobile; ?></td>
								</tr>
								<tr>
									<td><strong>Email : </strong></td>
									<td colspan="3"><?php echo $old_detail->Email; ?></td>
								</tr>
							</table>
							<?php //print_r($old_detail); ?>
				...
				<div class="row mt-1">
					...
					<div class="col-sm-12 text-center">
						...
						<?php $cctime_set = strtotime(date('Y-m-d H:i:s'));
							if(($adv_detail->adv_type == "New" && (strtotime($adv_detail->adv_end_time) > $cctime_set) && ($cctime_set > strtotime($adv_detail->adv_start_time))) || ($adv_detail->adv_type == "Old" && (strtotime($adv_detail->adv_old_endtime) > $cctime_set) && ($cctime_set > strtotime($adv_detail->adv_old_starttime)))){ ?>
						...
						<div class="col-sm-12 mb-4" style="background-color: #cfffff;">
							...
							<table class="table" width="100%">
								<tr>
									...
									<td><?php echo $old_detail->Father_Name; ?></td>
									<td><strong>Mother Name : </strong></td>
									<td><?php echo $old_detail->Mother_Name; ?></td>
								</tr>
								<tr>
									<td><strong>Gender : </strong></td>
									<td><?php echo $old_detail->Sex; ?></td>
									<td><strong>Marital Status : </strong></td>
									<td><?php echo $old_detail->Material_Status; ?></td>
								</tr>
								<tr>
									<td><strong>Nationality : </strong></td>
									<td><?php echo $old_detail->Nationality; ?></td>
									<td><strong>District : </strong></td>
									<td><?php echo $old_detail->District; ?></td>
								</tr>
								<tr>
									<td><strong>Address : </strong></td>
									<td width="30%"><?php echo $old_detail->Address; ?></td>
									<td><strong>Domicile State : </strong></td>
									<td><?php echo $old_detail->Domicile_State; ?></td>
								</tr>
							</table>
							<hr style="border-color:blue" />
							<?php //print_r($old_detail); ?>
			...
			<div class="step-tab-panel" data-step="step3">
						...
						<div class="col-sm-12 mb-4" style="background-color: #cfffff;">
							...
							<table class="table" width="100%">
								<tr>
									...
									<td><?php echo $old_detail->Category; ?></td>
									<td><strong>Caste Authority : </strong></td>
									<td><?php echo $old_detail->Authority_Name; ?></td>
								</tr>
								<tr>
									<td><strong>Caste Issue Date : </strong></td>
									<td><?php if(!empty($old_detail->Issue_Date)){echo date('d/m/Y',strtotime($old_detail->Issue_Date));} ?></td>
								</tr>
								<tr>
									<td><strong>EC Status : </strong></td>
									<td><?php echo $old_detail->Ec_Status; ?></td>
									<td><strong>EC Reason : </strong></td>
									<td><?php echo $old_detail->Ec_Reason; ?></td>
								</tr>
								<tr>
									<td><strong>Ex Service Status : </strong></td>
									<td><?php echo $old_detail->Ex_Service_Status; ?></td>
									<td><strong>Ph Status : </strong></td>
									<td><?php echo $old_detail->Ph_Status; ?></td>
								</tr>
								<tr>
									<td><strong>Age Relaxation : </strong></td>
									<td><?php echo $old_detail->Age_Relaxation; ?></td>
									<td><strong>Age Relaxation Reason : </strong></td>
									<td><?php echo $old_detail->Age_Relaxation_Reason; ?></td>
								</tr>
								<tr>
									<td><strong>Exempted : </strong></td>
									<td><?php echo $old_detail->Is_Exempted; ?></td>
									<td><strong>Exempted Category : </strong></td>
									<td><?php echo $old_detail->Exempted_Category; ?></td>
								</tr>
							</table>
							<hr style="border-color:blue" />
							<?php //print_r($old_detail); ?>
				...
				<?php if (($fuser_detailset->fu_step_1 == 1 && $fuser_detailset->fu_step_2 == 1)) { ?>
					...
					<?php if(!empty($old_detail) && $fuser_detailset->f_applied_for == 'AA031120211259004685'){ 
						$casarr = array('UR'=>1,'SC'=>2,'ST'=>3,'OBC'=>4,'OBC-A'=>5,'OBC-B'=>6); ?>
					
					<div class="row mt-3">

						<div class="col-sm-2">Caste :<?php //print_r($casarr);?></div>

						<div class="col-sm-10">
								<div class="row mb-3">
									<div class="col-sm-11">
								<select class="form-control" id="acc" name="fu_caste_type" onchange="yesnoCheck();" <?php if ($fuser_detailset->fu_step_3 == 1) {echo "disabled";} ?>>
								<?php $excattype = $extraattach = '';
								foreach ($caste_tab as $caste) : 
								if(!in_array($caste->caste_id,$allzero_vacancy)){ 
									if($caste->caste_id == $casarr[trim($old_detail->Category)]){ ?>

									<option value="<?= $caste->caste_id ?>" <?php if (!empty($fuser_detailset->fu_caste_type)){if ($fuser_detailset->fu_caste_type == $caste->caste_id) {echo 'selected';$excattype = $caste->caste_cat;$extraattach = $caste->caste_attach;}}else{if($caste->caste_id == $casarr[trim($old_detail->Category)]){echo 'selected';$excattype = $caste->caste_cat;$extraattach = $caste->caste_attach;}} ?>><?= $caste->caste_name ?></option>
							...
							<div id="ifYes" <?php if (!empty($fuser_detailset->fu_caste_type)){if($fuser_detailset->fu_caste_type == 1){echo 'style="display:none;"';}else{if($excattype == 1){echo 'style="display:none;"';}}}else{if($casarr[trim($old_detail->Category)] < 2){echo 'style="display:none;"';}} ?>>
								...
								<div class="row mt-2">
									...
									<div class="col-sm-4">
										...
										<select class="form-control" name="fu_caste_community" <?php if($casarr[trim($old_detail->Category)] < 2){if ($fuser_detailset->fu_caste_type == NULL || $fuser_detailset->fu_step_3 == 1) echo "disabled";} ?> autocomplete="off">
											<option value="">--SELECT--</option>
											...
											<?php }
													...
													foreach($oldcaste_communi_set as $castcom){ ?>
														<option value="<?= $castcom->csdetail_id ?>"><?= $castcom->csdetail_name ?></option>
													<?php }
												}
											} ?>
					...
					<?php }else{ ?>
						...
						<div class="row mt-3">
							...
							<div class="col-sm-2">Caste :<?php //print_r($allzero_vacancy);?></div>
								...
								<div id="ifYes" <?php if (!empty($fuser_detailset->fu_caste_type)){if($fuser_detailset->fu_caste_type == 1){echo 'style="display:none;"';}else{if($excattype == 1){echo 'style="display:none;"';}}}else{echo 'style="display:none;"';} ?>>
									...
									<div class="row mt-2">
										...
										<div class="col-sm-4">
											...
											<select class="form-control" name="fu_caste_community" <?php if ($fuser_detailset->fu_caste_type == NULL || $fuser_detailset->fu_step_3 == 1) echo "disabled" ?> autocomplete="off">
												<option value="">--SELECT--</option>
												<?php if ($fuser_detailset->fu_caste_type != NULL && $fuser_detailset->fu_caste_community != NULL) { ?>
													<option value="<?= $caste_community->csdetail_id ?>" selected><?= $caste_community->csdetail_name ?></option>
												<?php }else{
					...
					<div class="row mt-3 exempted_man" <?php if($extraattach != 1){echo 'style="display:none;"';} ?>>
							...
							<div class="row mt-2" id="ifyesexem" <?php //if ($fuser_detailset->fu_exempted == 'Yes') echo 'style="display:block"'; else echo 'style="display:none"'; ?>>
								...
								<div class="row pl-2">
									...
									<div class="col-sm-4">
										...
										<textarea class="form-control" rows="3" name="fu_exc_reason" id="fu_exc_reason" <?php if ($fuser_detailset->fu_step_3 == 1) {echo "disabled";} ?>><?= $fuser_detailset->fu_exc_reason ?></textarea>
					...
					<div class="row mt-3 exservice_man" <?php if($extraattach != 2){echo 'style="display:none;"';} ?>>
							...
							<div class="row mt-2" id="ifyesex" <?php //if ($fuser_detailset->fu_exservice == 'Yes') echo 'style="display:block"'; else echo 'style="display:none"'; ?>>
								...
								<div class="row pl-2">
									...
									<div class="col-sm-4">
										...
										<textarea class="form-control" rows="2" id="fu_exs_reason" name="fu_exs_reason" <?php if ($fuser_detailset->fu_step_3 == 1) {echo "disabled";} ?>><?= $fuser_detailset->fu_exs_reason ?></textarea>
					...
					<div class="row mt-3 sportsman_set" <?php if($extraattach != 3){echo 'style="display:none;"';} ?>>
						...
						<div class="col-sm-10"> <!--Yes
							...
							<div class="row mt-2" id="ifyesews" <?php //if ($fuser_detailset->fu_ews == 'Yes') echo 'style="display:block"'; else echo 'style="display:none"'; ?>>
								...
								<div class="row pl-2">
									...
									<div class="col-sm-4">
										...
										<textarea class="form-control" rows="2" id="fu_ews_reason" name="fu_ews_reason" <?php if ($fuser_detailset->fu_step_3 == 1) {echo "disabled";} ?>><?= $fuser_detailset->fu_ews_reason ?></textarea>
					...
					<?php if(!empty($extraage_list)){
						foreach($extraage_list as $etaitem){
							...
							if($ageitems->advage_section == $etaitem->fu_ext_ageid){
								...
								foreach($arrextraage_set as $keyss=>$exageitem){
									if(in_array($ageitems->advage_section,$exageitem)){
										$uage_keys = implode(",", $exageitem); //$exageitem;
										break;
									}
								}
								?>
							...
							<div class="row mt-3">
								...
								<div class="col-sm-10"> Yes
									<input type="radio" onclick="javascript:yesnoExtraage_Check(<?php echo $agecounter; ?>,<?php echo $ageitems->advage_section; ?>,'<?php echo $uage_keys; ?>');" name="yesno_extage_<?php echo $agecounter; ?>" <?php if ($etaitem->fu_ext_answer == 'Yes') echo 'checked' ?> value="Yes" id="yeschk_<?php echo $ageitems->advage_section; ?>"> No
									<input type="radio" onclick="javascript:yesnoExtraage_Check(<?php echo $agecounter; ?>,<?php echo $ageitems->advage_section; ?>,'<?php echo $uage_keys; ?>');" name="yesno_extage_<?php echo $agecounter; ?>" <?php if ($etaitem->fu_ext_answer == 'No') echo 'checked' ?> value="No" id="nochk_<?php echo $ageitems->advage_section; ?>"><br>
									<small class="text-error yesno_extage_<?php echo $agecounter; ?>"><?php echo form_error('yesno_extage_'.$agecounter); ?></small>
									
									<div class="row mt-2 yeschkclass_<?php echo $ageitems->advage_section; ?>" id="ifyesextage_<?php echo $agecounter; ?>" <?php if ($etaitem->fu_ext_answer == 'Yes'){ echo 'style="display:block"';} else {echo 'style="display:none"';} ?>>
										<div class="row pl-2">
					...
					<div class="row mt-3">
						<div class="col-sm-2"><?php echo $ageitems->caste_name; ?> :</div>
						<div class="col-sm-10"> Yes
							<input type="radio" onclick="javascript:yesnoExtraage_Check(<?php echo $agecounter; ?>,<?php echo $ageitems->advage_section; ?>,'<?php echo $uage_keys; ?>');" name="yesno_extage_<?php echo $agecounter; ?>" value="Yes" id="yeschk_<?php echo $ageitems->advage_section; ?>"> No
							<input type="radio" onclick="javascript:yesnoExtraage_Check(<?php echo $agecounter; ?>,<?php echo $ageitems->advage_section; ?>,'<?php echo $uage_keys; ?>');" name="yesno_extage_<?php echo $agecounter; ?>" value="No" id="nochk_<?php echo $ageitems->advage_section; ?>"><br>
							<small class="text-error yesno_extage_<?php echo $agecounter; ?>"><?php echo form_error('yesno_extage_'.$agecounter); ?></small>
							
							<div class="row mt-2 yeschkclass_<?php echo $ageitems->advage_section; ?>" id="ifyesextage_<?php echo $agecounter; ?>" style="display:none">
								<div class="row pl-2">
									<div class="col-sm-2 pl-4">Detail Description :</div>
									<div class="col-sm-4">
			...
			<div class="step-tab-panel" data-step="step4">
				<?php if(!empty($old_detail)){ ?>
					<div class="row">
						<div class="col-sm-12 mb-4" style="background-color: #cfffff;">
							...
							<table class="table" width="100%">
								<tr>
									<td><strong>Qualification 1</strong></td>
									<td><strong>Institute Name</strong></td>
									<td><strong>State of Passing</strong></td>
									<td><strong>Full Marks</strong></td>
									<td><strong>Marks Obtained</strong></td>
									<td><strong>Percentage of Marks</strong></td>
									<td><strong>Marksheet Issue Date</strong></td>
								</tr>
								<tr>
									<td><?php echo $old_detail->Q_1; ?></td>
									<td><?php echo $old_detail->Institude_Name; ?></td>
									<td><?php echo $old_detail->State_of_Passing_1; ?></td>
									<td><?php echo $old_detail->Full_Marks; ?></td>
									<td><?php echo $old_detail->Marks_Obtained; ?></td>
									<td><?php echo $old_detail->Percentage_of_Marks; ?></td>
									<td><?php if(!empty($old_detail->Marksheet_Issue_Date)){echo date('d/m/Y',strtotime($old_detail->Marksheet_Issue_Date));} ?></td>
								</tr>
								<tr>
									<td><?php echo $old_detail->Q_2; ?></td>
									<td><?php echo $old_detail->Institude_Name_2; ?></td>
									<td><?php echo $old_detail->State_of_Passing_2; ?></td>
									<td><?php echo $old_detail->Full_Marks_2; ?></td>
									<td><?php echo $old_detail->Marks_Obtained_2; ?></td>
									<td><?php echo $old_detail->Percentage_Marks_2; ?></td>
									<td><?php if(!empty($old_detail->Marksheet_Date_2)){echo date('d/m/Y',strtotime($old_detail->Marksheet_Date_2));} ?></td>
								</tr>
								<tr>
									<td colspan="7">&nbsp;</td>
								</tr>
								<tr>
									<td><strong>Experience in Service</strong></td>
									<td><strong>Govt. Experience (Year)</strong></td>
									<td><strong>Govt. Experience (Month)</strong></td>
									<td><strong>Non Govt. Experience (Year)</strong></td>
									<td colspan="3"><strong>Non Govt. Experience (Month)</strong></td>
								</tr>
								<tr>
									<td><?php echo $old_detail->Wheather_In_Service; ?></td>
									<td><?php echo $old_detail->Govt_Exp_Y_1; ?></td>
									<td><?php echo $old_detail->Govt_Exp_M_1; ?></td>
									<td><?php echo $old_detail->Non_Govt_Exp_Y_1; ?></td>
									<td colspan="3"><?php echo $old_detail->Non_Govt_Exp_M_1; ?></td>
								</tr>
								<tr>
									<td>&nbsp;</td>
									<td><?php echo $old_detail->Govt_Exp_Y_2; ?></td>
									<td><?php echo $old_detail->Govt_Exp_M_2; ?></td>
									<td><?php echo $old_detail->Non_Govt_Exp_Y_2; ?></td>
									<td colspan="3"><?php echo $old_detail->Non_Govt_Exp_M_2; ?></td>
								</tr>
								<tr>
									<td><strong>Category Reg Certificate under(WB) : </strong></td>
									<td colspan="2"><?php echo $old_detail->Category_Reg_Certificate; ?></td>
									<td>&nbsp;</td>
									<td><strong>RN No. : </strong></td>
									<td colspan="2"><?php echo $old_detail->RN_No; ?></td>
								</tr>
								<tr>
									<td><strong>One Year Practical Training as House Staff : </strong></td>
									<td colspan="2"><?php echo $old_detail->Practical_Training_HouseStaff; ?></td>
									<td>&nbsp;</td>
									<td><strong>Chance Lost : </strong></td>
									<td colspan="2"><?php echo $old_detail->Chance_Lost; ?></td>
								</tr>
								<tr>
									<td><strong>Date of Birth : </strong></td>
									<td colspan="6"><?php if(!empty($old_detail->DOB)){echo date('d-M-Y',strtotime($old_detail->DOB));} ?></td>
								</tr>
				...
				<?php if (($fuser_detailset->fu_step_1 == 1 && $fuser_detailset->fu_step_2 == 1 && $fuser_detailset->fu_step_3 == 1)) { ?>	
							...
							<div class="col-sm-12">
								...
								<table class="table">
									<thead>
										...
										<?php if($quali_persu_check == 1){ ?>
											<th>Final Qualification Pursuing</th>
										<?php } ?>
									...
									<?php $secarr = (array)$quali_list;
										...
										<tr>
											...
											<td>
												<?php foreach ($quali_exam[$q] as $exam) {
													if($exam['aquali_persuing'] == "Yes"){ ?>
													<input type="checkbox" class="form-control" name="exam_persuing_<?php echo $q; ?>" id="exam_persuing_<?php echo $q; ?>" value="Yes" <?php if(!empty($secarr[$q]->fu_is_pursuing)){if($secarr[$q]->fu_is_pursuing == $exam['aquali_persuing']){echo "checked";}} ?> />
												<?php }
												} ?>	
											</td>
											<?php } ?>
									...
									<tbody>
										<?php foreach($quali_list as $qualiss){ ?>
											<tr>
												...
												<?php if($quali_persu_check == 1){ ?>
													<td><?php echo $qualiss->fu_is_pursuing; ?></td>
												<?php } ?>
					...
					<div class="row mt-2">
						<div class="col-sm-12">
							<h3>Desirable Qualification (This is added after clicking "ADD ROW" button)</h3>
							<?php if ($fuser_detailset->fu_step_4 != 1) { ?>
							<div class="table-responsive">
							<table class="table">
								<thead>
					...
					<div class="row mt-3">
						...
						<?php if($adv_detail->adv_experience_no > 0){ ?>
							...
							<div class="col-sm-12">
								<h3>Essential Experience (This is added after clicking "ADD ROW" button)</h3>
								<div class="row">
									<div class="col-sm-12">
						...
						<div class="col-sm-12">
							...
							<div class="row mt-2" id="ifyesservice_des" <?php if ($fuser_detailset->fu_has_service != 'Yes'){echo 'style="display:none;"';} ?>>
								<div class="col-sm-12">
									<h3>Desirable Experience (This is added after clicking "ADD ROW" button)</h3>
									<?php if ($fuser_detailset->fu_step_4 != 1) { ?>
									<table class="table">
										<thead>
...
<script type="text/javascript">
	...
	<?php if (($fuser_detailset->fu_step_1 == 1 && $fuser_detailset->fu_step_2 == 1) && ($fuser_detailset->fu_step_3 == 0 || $fuser_detailset->fu_step_3 == 2)) { ?>
			...
			$.ajax({
				...
				success: function(data) {
					...
					if(data.msg == 1){
						...
						if(data.castetype.caste_attach == 1){
							$('.exempted_man').fadeIn();
							$('.exservice_man, .sportsman_set').fadeOut();
						}else if(data.castetype.caste_attach == 2){
							$('.exservice_man').fadeIn();
							$('.exempted_man, .sportsman_set').fadeOut();
						}else if(data.castetype.caste_attach == 3){
							$('.sportsman_set').fadeIn();
							$('.exempted_man, .exservice_man').fadeOut();
						}else{
							$('.exempted_man, .exservice_man, .sportsman_set').fadeOut();
						}
		...
		function three_step_save() {
			...
			var com_attachdoc_set = $('input[name="com_attachdoc_set"]').val();
			...
			if (fu_caste_type != "" && !fu_caste_type.match(onlynumerics)) {
				e_error = 1;
			...
			if(fu_caste_type != 1 && fu_caste_type != ""){
				...
				if(com_castetypeset == ""){
					...
					$('.fu_caste_community, .fu_caste_number, .fu_caste_issue_whom, .fu_caste_issue_date, .fu_caste_doc').html('');
				}
			...
			if (e_error == 1) {
				...
				form_data.append('com_attachdoc_set', com_attachdoc_set);
	...
	<?php if (($fuser_detailset->fu_step_1 == 1 && $fuser_detailset->fu_step_2 == 1 && $fuser_detailset->fu_step_3 == 1) && ($fuser_detailset->fu_step_4 == 0 || $fuser_detailset->fu_step_4 == 2)) { ?>
		...
		function four_step_save() {
			...
			for(var cntset = 0; cntset<totalexam; cntset++){
				...
				if($("input[name='exam_persuing_"+cntset+"']").is(':checked')){
					exam_persuing = "Yes";
				}
			...
			if (e_error == 1) {
				...
				for(var cntsetss = 0; cntsetss<totalexam; cntsetss++){
					...
					var exam_persuing = '';
					if($("input[name='exam_persuing_"+cntsetss+"']").is(':checked')){
						exam_persuing = "Yes";
					}
					...
					form_data.append('exam_persuing[]', exam_persuing);
...
<script type="text/javascript">
	function yesnoCheck() {
		...
		if (fu_caste_type != 1)
		{
			...
			form_data.append('fu_caste_type', fu_caste_type);
			$.ajax({
				url: '<?= base_url("member/get_caste_details_v3") ?>',
				method: 'POST',
				data: form_data,
				dataType: 'JSON',
				processData: false,
	...
	function yesnoExtraage_Check(ageid, agesets, passarr) {
		//alert(passarr);
		
		var getageval = $('input[name="yesno_extage_'+ageid+'"]:checked').val();
		if (getageval == 'Yes')
		{
			let myArray = passarr.split(",");
			for(var i = 0; i < myArray.length; i++){
				if(parseInt(myArray[i]) != parseInt(agesets)){
					$("#nochk_"+myArray[i]).prop("checked", true);
					$('.yeschkclass_'+myArray[i]).hide();
				}
			}
