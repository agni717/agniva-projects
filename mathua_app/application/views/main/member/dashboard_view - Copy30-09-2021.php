			...
			<div class="step-tab-panel" data-step="step4">
				...
				<div class="quali">
					...
					<div class="row ">
						...
						<div class="col">
							...
							<div class="row pl-2 pr-2"><label>Examination<br>Name </label></div>

							<div class="row pl-2 pr-2 ">

								<select class="form-control exam-name-input" name="exam_name" id="exampleFormControlSelect1" <?php 
								if($fuser_detailset->fu_step_4 == 1) {echo "disabled";} ?>>

									<?php foreach ($quali_exam as $exam) { ?>

										<option value="<?= $exam->aquali_exam ?>"><?= $exam->qm_name ?></option>
						...
						<div class="col">
							...
							<div class="row  pl-2 pr-2"><label>Board/ Council/ University</label>
						...
						<div class="col">
							...
							<div class="row  pl-2 pr-2">
								...
								<label>Percentage(%) of Marks <br></label>
							</div>
				...
				<div class="row mt-3">
					...
					<div class="col-sm-4">
						...
						<input type="file" name="fu_dob_doc" id="fu_dob_doc" class="form-control" autocomplete="off" <?php if ($fuser_detailset->fu_step_4 == 1) {
																															echo "disabled";
																														} ?> />
						<small class="">File format should be in .png/.jpg/.jpeg/.pdf format</small>
						<small class="">Maximum file size is 2 MB </small>
...
<script type="text/javascript">
	...
	<?php if (($fuser_detailset->fu_step_1 == 1 && $fuser_detailset->fu_step_2 == 1 && $fuser_detailset->fu_step_3 == 1) && ($fuser_detailset->fu_step_4 == 0 || $fuser_detailset->fu_step_4 == 2)) { ?>
		...
		<?php foreach ($fuser_quali as $quali) { ?>
			...
			usersQuali.push('<?= $quali->aquali_exam ?>');

		<?php } ?>

		<?php foreach ($quali_exam as $exam) { ?>

			examsID.push('<?= $exam->aquali_exam ?>');

			examsName.push('<?= $exam->qm_name ?>');

			exam['<?= $exam->aquali_exam ?>'] = '<?= $exam->qm_name ?>'
