...
<script type="text/javascript">
	...
	function chk_bal_calculation(){
		...
		var t_balance = (ex_stock + ap_receive) - ap_utilize;
	...
	function gotoclclickbutton(){
		...
		if(ap_utilize != "" && ap_receive != "" && ex_stock != ""){
			if(ap_utilize == 0 && ap_receive == 0){
				e_error = 1;
				error_message = error_message + '<br/>Both Utilize and Receive is 0 value, Change it.';
			}
		}
