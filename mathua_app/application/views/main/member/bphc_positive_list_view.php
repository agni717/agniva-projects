  	...
  	<div class="container">
    	<div class="row">
			...
			<div class="panel panel-default">
				...
				<h1 class="panel-title">Positive Case List</h1>
		...
		<div class="table-responsive">
			<table id="d_table_show" class="table table-bordered table-striped">
				<thead>
					<th>Sl No</th>
					<?php if($this->session->userdata('member_utype') == 4){ ?>
					<th>Action</th>
					<?php } ?>
					<th>Health Dist.</th>
					<th>Date</th>
				...
				<?php foreach($formlist as $keys=>$forms){ ?>
					<tr>
						...
						<td><?php if(empty($forms->pcase_id)){ ?>
						<a class="btn btn-xs btn-warning" href="<?php echo base_url()."member/positive_form_details_entryupdate/".$forms->collect_id; ?>" style="margin-bottom:5px;">Update Form</a>
						<?php }else{ echo '<span style="color:green">Record Inserted</span>'; } ?>
						</td>
						<?php } ?>
