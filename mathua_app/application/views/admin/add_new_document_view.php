              ...
              <div class="box box-primary">
                ...
                <?php echo form_open_multipart('','class="form-horizontal"'); ?>
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-3">
				      <input type="text" class="form-control" name="v_date" id="v_date" placeholder="Select Voucher Date">
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-3">
				      <input type="text" class="form-control" name="v_number" id="v_number" placeholder="Enter Voucher Number">
				    ...
				    <div class="col-sm-3">
				      <input type="text" class="form-control" name="v_year" id="v_year" placeholder="Enter Voucher Year">
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-9 bootstrap-timepicker">
				      <input type="text" class="form-control" name="party_name" id="party_name" placeholder="Enter Party Name">
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <textarea class="form-control" name="f_details" id="f_details" placeholder="Enter File Details"></textarea>
...
function get_document_submit(){
	...
	if(e_error == 1){
		...
		$.ajax({
			method:'POST',
			url:'<?php echo base_url()."admincontrol/panel/add_new_document"; ?>',
			data:form_data,
			dataType:'JSON',
			contentType: false,
			processData: false,
