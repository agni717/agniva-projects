...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Checker's Reverse Check List
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Checker's Reverse Check List</li>
          </ol>
        </section>
			  ...
			  <?php echo form_close(); ?>
                ...
                <div class="box-body">
				  ...
				  <div class="table-responsive" id="psetsss">
				  					<div class="row text-center" style="font-size:20px;">
									<div class="col-sm-6"><strong>Current Time</strong> - <?php echo date('d-m-Y h:i A'); ?></div>
									<div class="col-sm-6">Total Candidate - <strong><?php echo $total_cand; ?></strong></div>
									</div>
                  ...
                  <table class="table table-striped" id="datatable_tab11" width="100%">
	                  <thead style="font-weight: bold;">
					  		<td>Name (Level)</td>
	                  		<td>Approved</td>
							<td>Reverse Approved</td>
	                  		<td>Rejected</td>
	                  		<td>Reverse Rejected</td>
	                  </thead>
                  	<tbody>
					  	<tr>
                  		...
                  		<tr>
							...
							<td><?php echo $users['t_rev_approve']; ?></td>
                  			<td><?php echo $users['t_reject']; ?></td>
							<td><?php echo $users['t_rev_reject']; ?></td>
                  		</tr>	
						<?php } ?>
                  	</tbody>
                  </table>
