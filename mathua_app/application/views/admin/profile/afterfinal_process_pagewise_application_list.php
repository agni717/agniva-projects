...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            After Final Process Candidate Pagewise Status List
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">After Final Process Candidate Pagewise Status List</li>
          </ol>
        </section>
          ...
          <div class="row">
		    ...
		    <?php $this->session->unset_userdata('e_error'); } ?>
              ...
              <div class="box box-warning">
                <!-- /.box-header -->
				<form id="form123" action="<?php echo base_url('admincontrol/dashboard/after_finalprocess_pagewise_candidatestatus_list'); ?>" method="GET">
				<div class="box-body">
				<?php if (isset($error)) { ?>
