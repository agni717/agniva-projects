			  ...
			  <div class="box-body">
								<?php if(!empty($appli_list)){ ?>
									<div class="row text-center" style="font-size:20px;">
										<form action="<?php echo base_url('admincontrol/dashboard/checker_monitoring_pdf_sets'); ?>" target="_blank" method="post" id="form_1">
                  ...
                  <table border="1" cellpadding="3" class="" id="datatable_tab11" width="100%">
                  	...
                  	<tbody>
                  		...
                  		{ 
							...
							?>
                  		<tr>
                  			<td width="12%"><?php echo "<strong>".($keys + 1).".</strong> ".$users['cheker_name']." | ".$users['type_name']; ?></td>
