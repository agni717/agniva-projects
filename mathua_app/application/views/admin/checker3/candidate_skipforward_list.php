...
<script type="text/javascript">
	...
	function gotoclclickbutton(app_status){
		...
		$('.btnapprove, .btnreject, .btnskip').prop('disabled', true);
		//alert(app_status);
		//exit;
		var delay = 8000;
		var e_error = 0;
		...
		if(e_error == 1){
			...
			$('.btnapprove, .btnreject, .btnskip').prop('disabled', false);
			...
			$.ajax({
				...
				success:function(data){
					...
					if(data.msg == 1)
					{
						...
						<?php if(!empty($searchlist['sub_type'])){ ?>
							setTimeout(function(){ window.location.replace("<?php echo site_url('admincontrol/checker_set/candidate_chk3_skipforwad_list/'.$searchlist['advno'].'/'.$searchlist['adv_post_type'].'/'.$searchlist['u_accs'].'/'.$searchlist['sub_type'])?>"); }, 3000);
						<?php }else{ ?>
							setTimeout(function(){ window.location.replace("<?php echo site_url('admincontrol/checker_set/candidate_chk3_skipforwad_list/'.$searchlist['advno'].'/'.$searchlist['adv_post_type'].'/'.$searchlist['u_accs'])?>"); }, 3000);
						<?php } ?>
