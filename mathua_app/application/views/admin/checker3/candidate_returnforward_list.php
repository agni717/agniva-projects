...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Candidate's Return Application
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Candidate's Return Application</li>
          </ol>
        </section>
		<?php $str_arr = array(
							//'f_mobile' => 'Mobile',
							...
							<td width="50%">
								...
								<?php if($accessarray[0] == "ALL" || in_array("fu_has_ds_service", $accessarray)){ ?>
									...
									<tr>
										...
										<td>Checking Status: <strong><?php echo $checker_details->chk_final_state; ?></strong></td>
									</tr>
									<tr>
										<td colspan="2">Checking Comments: <?php echo $checker_details->chk2_comments; ?></td>
									</tr>
									<tr>
										<td colspan="2">
											<div>
			...
			$.ajax({
				...
				success:function(data){
					...
					if(data.msg == 1)
					{
						...
						<?php if(!empty($searchlist['sub_type'])){ ?>
							setTimeout(function(){ window.location.replace("<?php echo site_url('admincontrol/checker_set/candidate_chk3_returnforwad_list/'.$searchlist['advno'].'/'.$searchlist['adv_post_type'].'/'.$searchlist['u_accs'].'/'.$searchlist['sub_type'])?>"); }, 3000);
						<?php }else{ ?>
							setTimeout(function(){ window.location.replace("<?php echo site_url('admincontrol/checker_set/candidate_chk3_returnforwad_list/'.$searchlist['advno'].'/'.$searchlist['adv_post_type'].'/'.$searchlist['u_accs'])?>"); }, 3000);
						<?php } ?>
