						...
						<tr>
							<td width="50%">
								...
								<?php if($accessarray[0] == "ALL" || in_array("fu_has_ds_service", $accessarray)){ ?>
									...
									<?php } ?>
									<?php }} ?>
									<?php if(count((array)$alllog_comments) > 1){ ?>
									<tr>
										<td colspan="2"><strong>All Comments List:-</strong><br/>
										<?php foreach($alllog_comments as $keys=>$logcoms){
											echo "<u>Commnet ".($keys+1)."</u>. ".$logcoms->chklog_msg.' --- '.$logcoms->firstname.' '.$logcoms->lastname.' ('.$logcoms->mu_name.')<br/>';
										} ?>
										</td>
									</tr>
									<?php } ?>
										...
										<td colspan="5">
											<div>
											  <!--<a href="javascript:;" data-toggle="modal" data-target="#myModal" class="btn btn-lg btn-primary">Give Your Approval</a>-->
												...
												<div  class="col-sm-12 text-center">
											  	<button type="button" class="btn btn-primary btnapprove" onclick="gotoclclickbutton('Approved');">Approve</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<button type="button" class="btn btn-danger btnreject" onclick="gotoclclickbutton('Rejected');">Reject</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<button type="button" class="btn btn-info btnskip" onclick="gotoclclickbutton('Skip');">Skip</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<button type="button" class="btn btn-warning btncancel" onclick="gotocancel_clickbutton('NextSearch');">Next</button>
												</div>
							...
							<td width="50%" align="left">
								...
								<strong>Candidate Photograph -<a href="<?php echo $urllink.$appli_details->fu_photo_doc; ?>" target="_blank">Check Here</a></strong>&nbsp;&nbsp;&nbsp;<a class="btn btn-primary" onclick="gotomailsend_check('CO','1','<?php echo $appli_details->fu_photo_doc; ?>');">Send Mail</a>&nbsp;&nbsp;&nbsp;<a class="btn btn-warning" href="<?php echo base_url('admincontrol/candidates/document_history_checking/'.$appli_details->f_application_no.'/CO/1'); ?>" target="_blank">Check History</a><br/>
								<div><img id="dcopy_frameset" style="width:100%;max-width:550px;" src="<?php echo $urllink.$appli_details->fu_photo_doc; ?>" /></div><br/>
								<?php } ?>
								<?php if($accessarray[0] == "ALL" || in_array("fu_dob", $accessarray)){ ?>
								<strong>DOB Document -<a href="<?php echo $urllink.$appli_details->fu_dob_doc; ?>" target="_blank">Check Here</a></strong>&nbsp;&nbsp;&nbsp;<a class="btn btn-primary" onclick="gotomailsend_check('CO','4','<?php echo $appli_details->fu_dob_doc; ?>');">Send Mail</a>&nbsp;&nbsp;&nbsp;<a class="btn btn-warning" href="<?php echo base_url('admincontrol/candidates/document_history_checking/'.$appli_details->f_application_no.'/CO/4'); ?>" target="_blank">Check History</a><br/>
								...
								<?php } ?>
								<?php if($accessarray[0] == "ALL" || in_array("fu_address", $accessarray)){ ?>
								<strong>Address Proof -<a href="<?php echo $urllink.$appli_details->fu_address_doc; ?>" target="_blank">Check Here</a></strong>&nbsp;&nbsp;&nbsp;<a class="btn btn-primary" onclick="gotomailsend_check('CO','3','<?php echo $appli_details->fu_address_doc; ?>');">Send Mail</a>&nbsp;&nbsp;&nbsp;<a class="btn btn-warning" href="<?php echo base_url('admincontrol/candidates/document_history_checking/'.$appli_details->f_application_no.'/CO/3'); ?>" target="_blank">Check History</a><br/>
								...
								<strong>Signature Document -<a href="<?php echo $urllink.$appli_details->fu_signature_doc; ?>" target="_blank">Check Here</a></strong>&nbsp;&nbsp;&nbsp;<a class="btn btn-primary" onclick="gotomailsend_check('CO','2','<?php echo $appli_details->fu_signature_doc; ?>');">Send Mail</a>&nbsp;&nbsp;&nbsp;<a class="btn btn-warning" href="<?php echo base_url('admincontrol/candidates/document_history_checking/'.$appli_details->f_application_no.'/CO/2'); ?>" target="_blank">Check History</a><br/>
								...
								endforeach; ?>
								<?php if($excattype == 2){ ?>
									<strong>Caste Document -<a href="<?php echo $urllink.$appli_details->fu_caste_doc; ?>" target="_blank">Check Here</a></strong>&nbsp;&nbsp;&nbsp;<a class="btn btn-primary" onclick="gotomailsend_check('CO','5','<?php echo $appli_details->fu_caste_doc; ?>');">Send Mail</a>&nbsp;&nbsp;&nbsp;<a class="btn btn-warning" href="<?php echo base_url('admincontrol/candidates/document_history_checking/'.$appli_details->f_application_no.'/CO/5'); ?>" target="_blank">Check History</a><br/>
								...
								if($appli_details->fu_pwd == "Yes"){ ?>
									<strong>PWD Document -<a href="<?php echo $urllink.$appli_details->fu_pwd_doc; ?>" target="_blank">Check Here</a></strong>&nbsp;&nbsp;&nbsp;<a class="btn btn-primary" onclick="gotomailsend_check('CO','6','<?php echo $appli_details->fu_pwd_doc; ?>');">Send Mail</a>&nbsp;&nbsp;&nbsp;<a class="btn btn-warning" href="<?php echo base_url('admincontrol/candidates/document_history_checking/'.$appli_details->f_application_no.'/CO/6'); ?>" target="_blank">Check History</a><br/>
								...
								if($appli_details->fu_exempted == "Yes"){ ?>
									<strong>Document of Exempted -<a href="<?php echo $urllink.$appli_details->fu_exc_doc; ?>" target="_blank">Check Here</a></strong>&nbsp;&nbsp;&nbsp;<a class="btn btn-primary" onclick="gotomailsend_check('CO','7','<?php echo $appli_details->fu_exc_doc; ?>');">Send Mail</a>&nbsp;&nbsp;&nbsp;<a class="btn btn-warning" href="<?php echo base_url('admincontrol/candidates/document_history_checking/'.$appli_details->f_application_no.'/CO/7'); ?>" target="_blank">Check History</a><br/>
								...
								if($appli_details->fu_exservice == "Yes"){ ?>
									<strong>Document of ExServiceman -<a href="<?php echo $urllink.$appli_details->fu_exs_doc; ?>" target="_blank">Check Here</a></strong>&nbsp;&nbsp;&nbsp;<a class="btn btn-primary" onclick="gotomailsend_check('CO','8','<?php echo $appli_details->fu_exs_doc; ?>');">Send Mail</a>&nbsp;&nbsp;&nbsp;<a class="btn btn-warning" href="<?php echo base_url('admincontrol/candidates/document_history_checking/'.$appli_details->f_application_no.'/CO/8'); ?>" target="_blank">Check History</a><br/>
								...
								if($appli_details->fu_ews == "Yes"){ ?>
									<strong>Document of Sportsman -<a href="<?php echo $urllink.$appli_details->fu_ews_doc; ?>" target="_blank">Check Here</a></strong>&nbsp;&nbsp;&nbsp;<a class="btn btn-primary" onclick="gotomailsend_check('CO','9','<?php echo $appli_details->fu_ews_doc; ?>');">Send Mail</a>&nbsp;&nbsp;&nbsp;<a class="btn btn-warning" href="<?php echo base_url('admincontrol/candidates/document_history_checking/'.$appli_details->f_application_no.'/CO/9'); ?>" target="_blank">Check History</a><br/>
								...
								<?php if($accessarray[0] == "ALL" || in_array("fu_age_relax", $accessarray)){ ?>
									<?php foreach($spclage_list as $spageitems){
										if($searchlist['sub_type'] == $spageitems->fu_ext_ageid){ ?>
										<?php if($spageitems->fu_ext_answer == "Yes"){ ?>
										<strong>Document of Relaxation -<a href="<?php echo $urllink.$spageitems->fu_ext_doc; ?>" target="_blank">Check Here</a></strong>&nbsp;&nbsp;&nbsp;<a class="btn btn-primary" onclick="gotomailsend_check('EA','<?php echo $spageitems->fu_ext_id; ?>','<?php echo $spageitems->fu_ext_doc; ?>');">Send Mail</a>&nbsp;&nbsp;&nbsp;<a class="btn btn-warning" href="<?php echo base_url('admincontrol/candidates/document_history_checking/'.$appli_details->f_application_no.'/EA/'.$spageitems->fu_ext_id); ?>" target="_blank">Check History</a><br/>
								...
								<?php if($accessarray[0] == "ALL" || in_array("fu_es_qualification", $accessarray)){ ?>
									...
									<table class="table table-bordered table-striped">
										...
										<?php foreach($quali_details as $keys=>$qips){
											if($searchlist['sub_type'] == $qips->fu_qualifiaction_name){ ?>
										<tr>
											<td><?php echo ($keys+1).'. '.$qips->qm_name; ?> -<a href="<?php echo $urllink.$qips->fu_quali_docs; ?>" target="_blank">Check Here</a>&nbsp;&nbsp;&nbsp;<a class="btn btn-primary" onclick="gotomailsend_check('EQ','<?php echo $qips->fu_quali_id; ?>','<?php echo $qips->fu_quali_docs; ?>');">Send Mail</a>&nbsp;&nbsp;&nbsp;<a class="btn btn-warning" href="<?php echo base_url('admincontrol/candidates/document_history_checking/'.$appli_details->f_application_no.'/EQ/'.$qips->fu_quali_id); ?>" target="_blank">Check History</a><br/>
									...
									<?php if(!empty($appli_details->fu_ext_council_reg_certificate)){ ?>
										<strong>Registration Certificate -<a href="<?php echo $urllink.$appli_details->fu_ext_council_reg_certificate; ?>" target="_blank">Check Here</a></strong>&nbsp;&nbsp;&nbsp;<a class="btn btn-primary" onclick="gotomailsend_check('CO','10','<?php echo $appli_details->fu_ext_council_reg_certificate; ?>');">Send Mail</a>&nbsp;&nbsp;&nbsp;<a class="btn btn-warning" href="<?php echo base_url('admincontrol/candidates/document_history_checking/'.$appli_details->f_application_no.'/CO/10'); ?>" target="_blank">Check History</a><br/>
								...
								<?php if($accessarray[0] == "ALL" || in_array("fu_ds_qualification", $accessarray)){ ?>
									...
									<table class="table table-bordered table-striped">
										...
										<?php foreach($des_quali_details as $keys=>$qips){
											if($searchlist['sub_type'] == $qips->fud_qualifiaction_name){ ?>
										<tr>
											<td><?php echo ($keys+1).'. '.$qips->qm_name; ?> -<a href="<?php echo $urllink.$qips->fud_quali_docs; ?>" target="_blank">Check Here</a>&nbsp;&nbsp;&nbsp;<a class="btn btn-primary" onclick="gotomailsend_check('DQ','<?php echo $qips->fud_quali_id; ?>','<?php echo $qips->fud_quali_docs; ?>');">Send Mail</a>&nbsp;&nbsp;&nbsp;<a class="btn btn-warning" href="<?php echo base_url('admincontrol/candidates/document_history_checking/'.$appli_details->f_application_no.'/DQ/'.$qips->fud_quali_id); ?>" target="_blank">Check History</a><br/>
								...
								if($appli_details->fu_has_service == "Yes"){ ?>
									...
									<?php foreach($essenexp_details as $keys=>$exps){
										...
										<strong><?php echo $keys+1; ?>. <?php echo $exps->expset_name." (".$exps->fues_exp_org_name.")"; ?></strong> -<a href="<?php echo $urllink.$exps->fues_exp_marksheet_doc; ?>" target="_blank">Check Here</a>&nbsp;&nbsp;&nbsp;<a class="btn btn-primary" onclick="gotomailsend_check('ES','<?php echo $exps->fues_exp_id; ?>','<?php echo $exps->fues_exp_marksheet_doc; ?>');">Send Mail</a>&nbsp;&nbsp;&nbsp;<a class="btn btn-warning" href="<?php echo base_url('admincontrol/candidates/document_history_checking/'.$appli_details->f_application_no.'/ES/'.$exps->fues_exp_id); ?>" target="_blank">Check History</a><br/>
								...
								if($appli_details->fu_has_service == "Yes"){ ?>
									...
									<strong><?php echo $keys+1; ?>. <?php echo $exps->expset_name." (".$exps->fu_exp_org_name.")"; ?></strong> -<a href="<?php echo $urllink.$exps->fu_exp_marksheet_doc; ?>" target="_blank">Check Here</a>&nbsp;&nbsp;&nbsp;<a class="btn btn-primary" onclick="gotomailsend_check('DS','<?php echo $exps->fu_exp_id; ?>','<?php echo $exps->fu_exp_marksheet_doc; ?>');">Send Mail</a>&nbsp;&nbsp;&nbsp;<a class="btn btn-warning" href="<?php echo base_url('admincontrol/candidates/document_history_checking/'.$appli_details->f_application_no.'/DS/'.$exps->fu_exp_id); ?>" target="_blank">Check History</a><br/>
...
<script type="text/javascript">
	...
	function gotoclclickbutton(app_status){
		...
		$('.btnapprove, .btnreject, .btnskip, .btncancel').prop('disabled', true);
		//alert(app_status);
		//exit;
		var delay = 8000;
		var e_error = 0;
		...
		if(e_error == 1){
			...
			$('.btnapprove, .btnreject, .btnskip, .btncancel').prop('disabled', false);
			...
			$.ajax({
				method:'POST',
				url:'<?php echo base_url()."admincontrol/checker_set/checking_chk3_section_update"; ?>',
				...
				success:function(data){
					...
					if(data.msg == 1)
					{
						...
						<?php if(!empty($searchlist['sub_type'])){ ?>
							setTimeout(function(){ window.location.replace("<?php echo site_url('admincontrol/checker_set/candidate_chk3_nextforwad_list/'.$searchlist['advno'].'/'.$searchlist['adv_post_type'].'/'.$searchlist['u_accs'].'/'.$searchlist['sub_type'])?>"); }, 1000);
						<?php }else{ ?>
							setTimeout(function(){ window.location.replace("<?php echo site_url('admincontrol/checker_set/candidate_chk3_nextforwad_list/'.$searchlist['advno'].'/'.$searchlist['adv_post_type'].'/'.$searchlist['u_accs'])?>"); }, 1000);
						<?php } ?>
	...
	function gotocancel_clickbutton(app_status){
		$('.div_roller_total').fadeIn();
		$('.btnapprove, .btnreject, .btnskip, .btncancel').prop('disabled', true);
		//alert(app_status);
		//exit;
		...
		if(app_status != "NextSearch"){
			e_error = 1;
			error_message = error_message + '<br/>Check the Button Value Properly. Try Again.';
		}
		...
		if(e_error == 1){
			...
			$.ajax({
				method:'POST',
				url:'<?php echo base_url()."admincontrol/checker_set/checking_chk3_nextsearch_update"; ?>',
				data:{app_no: app_no, access_no: access_no, access_id: access_id, app_status: app_status},
				dataType:'JSON',
				success:function(data){
					//alert(data.msg);
					if(data.msg == 1)
					{
						...
						//alert(data.msg[0].space_rate);
						$('.div_roller_total').fadeOut();
						$('.get_success_total').html('Checking is Forwarded Successfully.');
						$(".get_success_total").fadeIn();
						$('select, textarea').val('');
						$('select, textarea').html('');
						setTimeout(function(){ $('.get_success_total').fadeOut(); }, 3000);
