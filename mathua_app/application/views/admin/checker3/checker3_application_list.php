							...
							<td width="50%">
								<table>
									...
									<tr>
										...
										<td><?php echo $appli_details->fu_caste; ?></td>
									</tr>
									<?php if($appli_details->fu_caste == "Yes"){ ?>
									<tr>
										<td><strong>Caste Type</strong></td>
									...
									<tr>
										...
										<td><?php echo $appli_details->fu_caste_issue_whom; ?></td>
									</tr>
									<tr>
							...
							<td width="50%" align="left">
								...
								<?php if($accessarray[0] == "ALL" || in_array("fu_qualification", $accessarray)){ ?>
									...
									<table class="table table-bordered table-striped">
										...
										<tr>
											<td><?php echo ($keys+1).'. '.$qips->qm_name; ?><br/>
								...
								if($appli_details->fu_has_service == "Yes"){ ?>
									...
									<?php foreach($essenexp_details as $keys=>$exps){ ?>
										<strong><?php echo $keys+1; ?>. <?php echo $exps->expset_name." (".$exps->fues_exp_org_name.")"; ?></strong><br/>
									...
									<strong><?php echo $keys+1; ?>. <?php echo $exps->expset_name." (".$exps->fu_exp_org_name.")"; ?></strong><br/>
			...
			$.ajax({
				...
				success:function(data){
					...
					if(data.msg == 1)
					{
						...
						setTimeout(function(){ window.location.replace("<?php echo site_url('admincontrol/checker_set/candidate_chk3_nextforwad_list')?>"); }, 3000);
						...
						setTimeout(function(){ window.location.replace("<?php echo site_url('admincontrol/checker_set/candidate_chk3_nextforwad_list')?>"); }, 4000);
