		    ...
		    <?php $this->session->unset_userdata('e_error'); } ?>
              ...
              <div class="box box-warning">
				...
				<div class="col-sm-12 text-center">
					<div class="form-group">
					<label class="control-label" style="font-size:20px;">Candidate Name (Reg. No.) : <?php echo $return_marks_detail->f_full_name.' ('.$return_marks_detail->invw_cand_regno.')'; ?></label>
					<!--<br/>
				...
				<div class="col-sm-offset-1 col-sm-2">
					<div class="form-group">
						<label class="control-label">Interview Attendance : <br/><?php echo $return_marks_detail->invw_attendance; ?></label>
				    </div>
				</div>
				<div class="col-sm-3">
					<div class="form-group">
						<label class="control-label">Language Knowledge : <br/><?php if($return_marks_detail->invw_attendance == "Yes"){echo $return_marks_detail->invw_language;}else{echo "&bsp;-&nbsp;";} ?></label>
					</div>
				</div>
				<div class="col-sm-3">
					<div class="form-group">
						<label class="control-label">Interview Marks(10) : <br/><?php if($return_marks_detail->invw_attendance == "Yes"){echo $return_marks_detail->invw_marks_1;}else{echo "&bsp;-&nbsp;";} ?></label>
				    </div>
				</div>
				<div class="col-sm-3">
					<div class="form-group">
						<label class="control-label">Interview Marks(5) : <br/><?php if($return_marks_detail->invw_attendance == "Yes"){echo $return_marks_detail->invw_marks_2;}else{echo "&bsp;-&nbsp;";} ?></label>
				    </div>
				</div>
				<div class="clearfix"></div>
				<div class="col-sm-12">
				...
				<div class="col-sm-12 text-center" style="margin-top:5px;">
					<a href="javascript:;" class="btn btn-success" onclick="gotocandidate_marks_check('A',<?php echo $return_marks_detail->invw_id; ?>,'<?php echo $return_marks_detail->invw_cand_regno; ?>');">Approve</a>&nbsp;&nbsp;<a href="javascript:;" class="btn btn-danger" onclick="gotocandidate_marks_check('R',<?php echo $return_marks_detail->invw_id; ?>,'<?php echo $return_marks_detail->invw_cand_regno; ?>');">Return</a>&nbsp;

					<a href="<?php echo base_url('admincontrol/movement/getall_revertset_marksmodification_list'); ?>" class="btn btn-primary">Cancel</a>
                </div>
				<div class="clearfix"></div>
              </div>
				...
				$.ajax({
					...
					success:function(data){
						...
						if(data.msg == 1)
						{
							...
							setTimeout(function(){ 
								window.location.replace("<?php echo base_url('admincontrol/movement/getall_revertset_marksmodification_list') ?>"); }, 1000);
