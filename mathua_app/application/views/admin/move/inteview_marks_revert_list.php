...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
		  Interview Marks Revert List
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Interview Marks Revert List</li>
          </ol>
        </section>
                  ...
                  <table class="table" id="datatable_tab" width="100%">
                  	...
                  	<tbody>
                  		...
                  		<tr>
							...
							<td style="width:100px;"><a class="btn-sm btn-danger" href="<?php echo base_url().'admincontrol/movement/modify_chk2_revertdata_inthecheckerend/'.$users->invw_id; ?>" title="Modify Interview Marks">Modify</a></td>
                  		</tr>	
						<?php } ?>
                  	</tbody>
                  </table>
