...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
		  Interview Marks Insertion
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Interview Marks Insertion</li>
          </ol>
        </section>
				  ...
				  <hr style="border-color:#aaa;" />
					<table width="100%">
						...
						<tbody class="cand_items">
							<!--<tr>
								<td>SAAS SDAD fsd fsdfsdfsdf sdf</td>
								<td>
									<div>
										<div class="radio">
											<label>
												<input type="radio" name="atten_intv" id="atten_intv1" value="Yes" autocomplete="off" checked> Yes
											</label>
											&nbsp;&nbsp;&nbsp;
											<label>
												<input type="radio" name="atten_intv" id="atten_intv2" value="No" autocomplete="off"> No
											</label>
										</div>
								...
								<td>
									<div>
										<div class="radio">
											<label>
												<input type="radio" name="intv_lang" id="intv_lang1" value="Yes" autocomplete="off" checked> Yes
											</label>
											&nbsp;&nbsp;&nbsp;
											<label>
												<input type="radio" name="intv_lang" id="intv_lang2" value="No" autocomplete="off"> No
											</label>
											&nbsp;&nbsp;&nbsp;
											<label>
												<input type="radio" name="intv_lang" id="intv_lang3" value="Not Applicable" autocomplete="off"> Not Applicable
											</label>
										</div>
								...
								<td>
									<div>
										<input type="text" class="form-control" name="intv1_mark" id="intv1_mark" />
										<small class="text-error intv1_mark"><?php //echo form_error('intv1_mark'); ?></small>
									</div>
								</td>
								<td>
									<div>
										<input type="text" class="form-control" name="intv2_mark" id="intv2_mark" />
