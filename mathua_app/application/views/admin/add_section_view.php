              ...
              <div class="box box-primary">
                ...
                <?php echo form_open_multipart('','class="form-horizontal"'); ?>
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <input type="text" class="form-control" name="s_name" id="s_name" placeholder="Enter Section Name">
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <textarea class="form-control" name="s_details" id="s_details" placeholder="Enter Section Details"></textarea>
...
function get_sanction_submit(){
	...
	if(san_name != ""){
		...
		$.ajax({
		method:'POST',
		url:'<?php echo base_url()."admincontrol/panel/add_new_section"; ?>',
		data:form_data,
		dataType:'JSON',
		contentType: false,
		processData: false,
