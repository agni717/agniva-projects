			...
			<div class="row">
				<div class="col-md-12 mt-5">
					<div class="widget-area-2 proclinic-box-shadow mb-3">
                     <h3 class="widget-title">District Executive List</h3>
						...
						<div class="table-responsive mb-3">
							<table id="tableId" class="table table-bordered table-striped">
								...
								<tbody>
									<?php foreach($dist_executive_list as $keys=>$users){ ?>
									<tr>												
										...
										<td><?php if($users->user_status == 1){ ?>
										  ...
										  <?php } ?></td>
										<td>
											<a href="<?php echo base_url().'admincontrol/dashboard/edit_district_executive/'.$users->u_id; ?>" title="Edit User"><span class="ti-pencil"></span></a>
											<?php if($users->user_status == 1){ ?>	
											<a href="<?php echo base_url().'admincontrol/dashboard/lock_district_executive/'.$users->u_id; ?>" title="Lock User"><span class="ti-unlock"></span></a>
											<?php } else { ?>
											<a href="<?php echo base_url().'admincontrol/dashboard/unlock_district_executive/'.$users->u_id; ?>" title="Unock User"><span class="ti-lock"></span></a>
											<?php } ?>
