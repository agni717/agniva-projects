			...
			$.ajax({
				...
				success:function(data){
					...
					if(data.msg == 1)
					{
						...
						<?php if(!empty($searchlist['sub_type'])){ ?>
							setTimeout(function(){ window.location.replace("<?php echo site_url('admincontrol/candidates/candidate_skipforwad_list/'.$searchlist['advno'].'/'.$searchlist['adv_post_type'].'/'.$searchlist['u_accs'].'/'.$searchlist['sub_type'])?>"); }, 3000);
						<?php }else{ ?>
							setTimeout(function(){ window.location.replace("<?php echo site_url('admincontrol/candidates/candidate_skipforwad_list/'.$searchlist['advno'].'/'.$searchlist['adv_post_type'].'/'.$searchlist['u_accs'])?>"); }, 3000);
						<?php } ?>	
