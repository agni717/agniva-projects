...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Candidate's Approve Application List
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Candidate's Approve Application List</li>
          </ol>
        </section>
					...
					<div class="row">
						<div class="col-sm-9 col-sm-offset-2">
							...
							<div class="row">
								...
								<div class="col-sm-4">
									<label class="checkbox-inline"><input type="checkbox" name="app_lvl" value="<?php echo $appsets->chk_user_application; ?>" autocomplete="off"><?php echo $appsets->chk_user_application.' ('.$appsets->f_full_name.')'; ?></label>
								</div>
								<?php } ?>
							</div>
