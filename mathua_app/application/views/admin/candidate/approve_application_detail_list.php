      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Application - Approve List</li>
          </ol>
        </section>
						...
						foreach($approv_list as $keys=>$users)
                  		...
                  		<tr>
                  			...
                  			<td>
								...
								<a href="<?php echo base_url().'admincontrol/candidates/candidate_application_modify/'.$users->f_application_no.'/'.$users->chk_id.'/A'; ?>" title="Modify" class="btn btn-warning">Modify Approval</a>
								<?php }else{ ?>
