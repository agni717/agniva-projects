...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Candidate's Doubtful Skip Application
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Candidate's Doubtful Skip Application</li>
          </ol>
        </section>
		<?php $str_arr = array(
							//'f_mobile' => 'Mobile',
		    ...
		    <?php $this->session->unset_userdata('e_error'); } ?>
              ...
              <div class="box box-warning">
				...
				<div class="col-sm-6">
				  <div class="form-group">
					<label>Checker Type :
					<?php if($searchlist['subuser_type'] != "All"){echo $searchlist['subuser_name'];}else{echo $searchlist['subuser_type'];} ?>
					</label>
				  </div>
				</div>
						...
						<tr>
							<td width="50%">
								...
								<?php if($accessarray[0] == "ALL" || in_array("fu_has_ds_service", $accessarray)){ ?>
									...
									<?php }} ?>
									<tr>
										<td colspan="2"><strong><u>Checker Details</u>:-</strong></td>
									</tr>
									<tr>
										<td>Checked By: <strong><?php echo $checker_details->firstname.' '.$checker_details->lastname.' ('.$checker_details->mu_name.')'; ?></strong></td>
										<td>Checking Status: <strong><?php echo $checker_details->chk_approve; ?></strong></td>
									</tr>
									<tr>
										<td colspan="2">Checking Comments: <?php echo $checker_details->chk_comments; ?></td>
									</tr>
									<tr>
										<td colspan="2"><strong><u>Skip Details</u>:-</strong></td>
									</tr>
									<tr>
										<td>Checked By: <strong><?php echo $cur_checker_details->firstname.' '.$cur_checker_details->lastname.' ('.$cur_checker_details->mu_name.')'; ?></strong></td>
										<td>Checking Status: <strong><?php echo $cur_checker_details->chk2_approve; ?></strong></td>
									</tr>
									<tr>
										<td colspan="2">Checking Comments: <?php echo $cur_checker_details->chk2_comments; ?></td>
									</tr>
									<tr>
										<td colspan="5">
											<div>
											  <!--<a href="javascript:;" data-toggle="modal" data-target="#myModal" class="btn btn-lg btn-primary">Give Your Approval</a>-->
												...
												<?php if($checker_details->chk_create_by_type == 4){ ?>
												<button type="button" class="btn btn-default" onclick="gotoclclickbutton('Return');">Return</button>
												<?php } ?>
												</div>
...
<script type="text/javascript">
	...
	function gotoclclickbutton(app_status){
		...
		if(app_status == ""){
			...
			if(app_status == "Rejected" || app_status == "Return" || app_status == "Skip"){
				if(app_comment == ""){
					e_error = 1;
			...
			$.ajax({
				...
				success:function(data){
					...
					if(data.msg == 1)
					{
						...
						<?php if(!empty($searchlist['sub_type'])){ ?>
							setTimeout(function(){ window.location.replace("<?php echo site_url('admincontrol/candidates/candidate_chk2_doubtful_skip_nextforwad_list/'.$searchlist['advno'].'/'.$searchlist['adv_post_type'].'/'.$searchlist['u_accs'].'/'.$searchlist['subuser_type'].'/'.$searchlist['sub_type'])?>"); }, 3000);
						<?php }else{ ?>
							setTimeout(function(){ window.location.replace("<?php echo site_url('admincontrol/candidates/candidate_chk2_doubtful_skip_nextforwad_list/'.$searchlist['advno'].'/'.$searchlist['adv_post_type'].'/'.$searchlist['u_accs'].'/'.$searchlist['subuser_type'])?>"); }, 3000);
						<?php } ?>
