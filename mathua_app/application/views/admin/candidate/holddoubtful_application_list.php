...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Doubtful Application List
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Doubtful Application List</li>
          </ol>
        </section>
				...
				<div class="col-sm-offset-1 col-sm-9">
				  <div class="form-group">
					<label>Advertisement No.</label>
					  <select class="form-control selectpicker" name="advno" id="advno" autocomplete="off">
                  ...
                  <table class="table table-striped" id="datatable_tab" width="100%">
                  	...
                  	<tbody>
                  		...
                  		<tr>
                  			...
                  			<td>
                  				<a target="_blank" href="<?php echo base_url().'admincontrol/candidates/candidate_doubtful_application_details/'.$users->f_application_no; ?>" title="View Details"><i class="fa fa-eye text-warning"></i></a>
