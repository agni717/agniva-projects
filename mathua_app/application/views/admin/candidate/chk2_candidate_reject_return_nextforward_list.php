...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Candidate's Rejected Return Application
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Candidate's Rejected Return Application</li>
          </ol>
        </section>
		<?php $str_arr = array(
							//'f_mobile' => 'Mobile',
			...
			$.ajax({
				...
				success:function(data){
					...
					if(data.msg == 1)
					{
						...
						<?php if(!empty($searchlist['sub_type'])){ ?>
							setTimeout(function(){ window.location.replace("<?php echo site_url('admincontrol/candidates/candidate_chk2_reject_return_nextforwad_list/'.$searchlist['advno'].'/'.$searchlist['adv_post_type'].'/'.$searchlist['u_accs'].'/'.$searchlist['subuser_type'].'/'.$searchlist['sub_type'])?>"); }, 3000);
						<?php }else{ ?>
							setTimeout(function(){ window.location.replace("<?php echo site_url('admincontrol/candidates/candidate_chk2_reject_return_nextforwad_list/'.$searchlist['advno'].'/'.$searchlist['adv_post_type'].'/'.$searchlist['u_accs'].'/'.$searchlist['subuser_type'])?>"); }, 3000);
						<?php } ?>
