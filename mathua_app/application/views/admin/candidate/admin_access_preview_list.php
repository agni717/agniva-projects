									...
									<tr>
										...
										<table class="table table-bordered table-striped">
											...
											<tr>
												...
												<td><a href="javascript:;" class="btn btn-danger" onclick="gotomark_update_by_checker(<?php echo $qips->fu_quali_id; ?>,<?php echo $qips->fu_fullmark_ck; ?>,<?php echo $qips->fu_obtainmark_ck; ?>,<?php echo $qips->fu_percentmark_ck; ?>,'E');">Modify</a></td>
											</tr>
											<?php } ?>
										</table>
										</div>
									...
									<tr>
										...
										<table class="table table-bordered table-striped">
											...
											<tr>
												...
												<td><a href="javascript:;" class="btn btn-danger" onclick="gotomark_update_by_checker(<?php echo $qips->fud_quali_id; ?>,<?php echo $qips->fud_fullmark_ck; ?>,<?php echo $qips->fud_obtainmark_ck; ?>,<?php echo $qips->fud_percentmark_ck; ?>,'D');">Modify</a></td>
											</tr>
											<?php } ?>
										</table>
										</div>
							...
							<td width="50%" align="left">
								...
								<?php if($accessarray[0] == "ALL" || in_array("fu_qualification", $accessarray)){ ?>
									...
									<?php if(!empty($appli_details->fu_ext_council_reg_certificate)){ ?>
										<strong>Registration Certificate -<a href="<?php echo $urllink.$appli_details->fu_ext_council_reg_certificate; ?>" target="_blank">Check Here</a></strong><br/>
										<?php if(strtolower(substr($appli_details->fu_ext_council_reg_certificate, -4)) == '.pdf'){ ?>
											<iframe id="dcopy_frameset" width="100%" height="max-width:100%;500px;" src="<?php echo $urllink.$appli_details->fu_ext_council_reg_certificate; ?>"></iframe><br/>
										<?php }else{ ?>
