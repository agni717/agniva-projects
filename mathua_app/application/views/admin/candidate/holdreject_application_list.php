      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Reject Application List</li>
          </ol>
        </section>
                  ...
                  <table class="table table-striped" id="datatable_tab" width="100%">
                  	...
                  	<tbody>
                  		...
                  		<tr>
                  			...
                  			<td>
                  				<a target="_blank" href="<?php echo base_url().'admincontrol/candidates/candidate_reject_application_details/'.$users->f_application_no; ?>" title="View Details"><i class="fa fa-eye text-warning"></i></a>
