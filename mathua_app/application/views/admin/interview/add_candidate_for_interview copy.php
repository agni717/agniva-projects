...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
		  		Interview Candidate Segrigation
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Interview Candidate Segrigation</li>
          </ol>
        </section>
              ...
              <div class="box box-warning">
				...
				<div class="col-sm-offset-1 col-sm-4">
					<div class="form-group">
						<input type="hidden" class="form-control" name="adv_temp_intvno" id="adv_temp_intvno" value="<?php echo date('dmyHis'); ?>" autocomplete="off" />
						<input type="hidden" class="form-control" name="catg_counter" id="catg_counter" value="0" autocomplete="off" />
						<label>Select Candidate</label>
						<div>
							<div class="radio">
								<label>
									<input type="radio" name="has_cand_main" id="has_cand_main1" value="ALL" autocomplete="off" checked> ALL
								</label>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<label>
									<input type="radio" name="has_cand_main" id="has_cand_main2" value="EC" autocomplete="off"> Except Coatcase
								</label>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<label>
									<input type="radio" name="has_cand_main" id="has_cand_main3" value="IC" autocomplete="off"> Only Coatcase
								</label>
							</div>
							<small class="text-error has_cand_main"><?php echo form_error('has_cand_main'); ?></small>
						</div>
					</div>
				</div>
				<div class="col-sm-4">
					<div class="form-group">
						...
						<div>
							<div class="radio">
								<label>
									<input type="radio" name="intcand_sec" id="intcand_sec1" value="ALL" autocomplete="off" onchange="check_inv_cand();" checked> ALL
								</label>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<label>
									<input type="radio" name="intcand_sec" id="intcand_sec2" value="MM" autocomplete="off" onchange="check_inv_cand();" > Minimum Marks
								</label>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<label>
									<input type="radio" name="intcand_sec" id="intcand_sec3" value="MV" autocomplete="off" onchange="check_inv_cand();" > Multiple of Vacancies
								</label>
							</div>
							<small class="text-error intcand_sec"><?php echo form_error('intcand_sec'); ?></small>
						</div>
					</div>
				</div>
				<div class="col-sm-2">
					<div class="form-group second_cand_input" style="display:none;">
						<label class="cand_selection_no_lvl"></label>
						<input type="text" class="form-control" name="cand_selection_no" id="cand_selection_no" placeholder="Enter Number" autocomplete="off" />
				    <small class="text-error cand_selection_no"><?php echo form_error('cand_selection_no'); ?></small>
					</div>
				</div>
				...
				<div class="clearfix"></div>
				<div class="col-sm-12">
       				 <div class="form-group gotocand_chcek text-center" style="font-size:20px;">
				...
				<div class="col-sm-offset-3 col-sm-6">
					<table width="100%" class="table">
						...
						<tbody class="setall_experiences">
							<tr>
								<td>
									<select class="form-control" name="advcat_name" id="advcat_name" autocomplete="off" disabled>
										<option value="">---Select---</option>
									</select>
									<small class="text-error advcat_name"><?php echo form_error('advcat_name'); ?></small>
								</td>
								<td>
									<input type="text" class="form-control" name="advcat_table" id="advcat_table" placeholder="Enter Total Table Number" autocomplete="off" disabled />
									<small class="text-error advcat_table"><?php echo form_error('advcat_table'); ?></small>
								</td>
								<td>
									<a href="javascript:;" class="btn btn-primary" id="catsetbutton" onclick="gotosubmit_catset();" disabled>ADD</a>
								</td>
							</tr>
							<tr>
								<td colspan="3">
				...
				<div class="clearfix"></div>
				<div class="col-sm-12">
       				 <div class="form-group gototable_chcek text-center" style="font-size:20px;">
				...
				<div class="col-sm-offset-1 col-sm-2">
				  <div class="form-group">
					<label>Venue</label>
					  <input type="hidden" name="max_table_set" id="max_table_set" value="" />
					  <select class="form-control selectpicker" name="venueno" id="venueno" onchange="goto_check_totaltab();" autocomplete="off">
							<option value="">---Select---</option>
				...
				<div class="col-sm-2">
					...
					<label class="control-label">Shift Start Time<font style="color: red;">*</font></label>
				...
				<div class="col-sm-2">
					<div class="form-group bootstrap-timepicker">
					<label class="control-label">Shift End Time<font style="color: red;">*</font></label>
				...
				<div class="col-sm-2">
					<div class="form-group">
					<label class="control-label">No. of Table<font style="color: red;">*</font></label>
				    <input type="text" class="form-control" name="table_no" id="table_no" placeholder="No. of Table" value="<?php //echo set_value('table_no'); ?>" autocomplete="off" />
				    <small class="text-error table_no"><?php //echo form_error('table_no'); ?></small>
				    </div>
				</div>-->
				<div class="col-sm-2">
					<div class="form-group">
					<label class="control-label">Each Table Strength<font style="color: red;">*</font></label>
				    <input type="text" class="form-control" name="table_stn" id="table_stn" placeholder="No. of Per Table Strength" value="<?php echo set_value('table_stn'); ?>" autocomplete="off" />
				    <small class="text-error table_stn"><?php echo form_error('table_stn'); ?></small>
				    </div>
				</div>
				<div class="clearfix"></div>
                  ...
                  <table class="table table-striped" id="datatable_tab" width="100%">
	                  <thead style="font-weight: bold;">
							...
							<td>Candidate Mobile</td>
	                  		<td>Action Taken</td>
	                  		<td style="max-width:200px;">Comments</td>
	                  		<td>Date-time</td>
							<td>Action</td>
	                  </thead>
                  	<tbody>
                  		...
                  		<tr>
                  			...
                  			<td><?php echo $users->firstname." ".$users->lastname." | ".$users->mu_name; ?></td>
							<td><?php echo $users->f_application_no; ?></td>
							<td><?php echo $users->f_full_name; ?></td>
							<td><?php echo $users->f_mobile; ?></td>
                  			<td><?php if($result_utypes == 3){echo $users->chk2_approve;}else{echo $users->chk_approve;} ?></td>
							<td><?php if($result_utypes == 3){echo $users->chk2_comments;}else{echo $users->chk_comments;} ?></td>
							...
							<td style="width:100px;"><a target="_blank" class="btn-sm btn-primary" href="<?php echo base_url().'admincontrol/candidates/candidate_application_details/'.$users->f_application_no; ?>" title="View Candidate Details"><i class="fa fa-eye text-default"></i></a><br/><a onclick="return confirm('You are about to delete a record of Checking. This cannot be undone. Are you sure?');" href="<?php echo base_url().'admincontrol/dashboard/removeall_action_against_check/'.$users->chk_id; ?>" class="btn-sm btn-danger">Remove Action</a></td>
                  		</tr>	
						<?php } ?>
                  	</tbody>
                  </table>
...
<script type="text/javascript">
	...
	function gotosubmit_catset() {
		...
		if (e_error == 1) {
			...
			$.ajax({
				method: 'POST',
				url: '<?php echo base_url() . "admincontrol/interview/new_category_submission_adv"; ?>',
				data: form_data,
				dataType: 'JSON',
				contentType: false,
				processData: false,
				success: function(data) {
					...
					if (data.msg == 1) {
						...
						var expr_string = '<tr class="expset_' + data.cat_set.idm_id + '"><td>' + data.cat_set.catm_name + '</td><td>' + data.cat_set.idm_cat_tableno + '</td><td><a href="javascript:;" onclick="gotodelete_cats(' + data.cat_set.idm_id + ');"><i class="fa fa-trash-o text-danger"></i></a></td></tr>';
			...
			$.ajax({
				...
				success:function(data){
					...
					if(data.msg == 1)
					{
						...
						$('#advcat_name, #advcat_table, #pa_target_submit').prop('disabled', true);
				...
				success:function(data){
					...
					if(data.msg == 1)
					{
						...
						if(parseInt(data.op_set) > 0){
							...
							$('#advcat_table').val('');
							$('.gotocand_chcek').html(data.op_set + " - Record Found For Interview Call Letter" + data.item_set);
							$(".gotocand_chcek").fadeIn();
							$('#advcat_name, #advcat_table, #pa_target_submit').prop('disabled', false);
	...
	function goto_submit_button(){
		...
		var advno = $("#advno option:selected").val();
		var adv_temp_intvno = $('#adv_temp_intvno').val();
		var catg_counter = $('#catg_counter').val();
		
		if (has_cand_main == "" || has_cand_main == undefined) {
			e_error = 1;
			$('.has_cand_main').html('Candidate Selection is Required.');
		} else {
			if (!has_cand_main.match(alphaletters)) {
				e_error = 1;
				$('.has_cand_main').html('Candidate Selection only Alphabet value, Check again.');
			} else {
				$('.has_cand_main').html('');
			}
		}
		if (intcand_sec == "" || intcand_sec == undefined) {
			e_error = 1;
			$('.intcand_sec').html('Interview Candidate is Required.');
		} else {
			if (!intcand_sec.match(alphaletters)) {
				e_error = 1;
				$('.intcand_sec').html('Interview Candidate only Alphabet value, Check again.');
			} else {
				$('.intcand_sec').html('');
				if(intcand_sec == "MM" || intcand_sec == "MV"){
					if (cand_selection_no == "") {
						e_error = 1;
						$('.cand_selection_no').html('Enter Number is Required.');
					} else {
						if(intcand_sec == "MM"){
							if (!cand_selection_no.match(onlynumerics_withdot)) {
								e_error = 1;
								$('.cand_selection_no').html('Enter Number only use Numeric values, Check again.');
							} else {
								$('.cand_selection_no').html('');
							}
						}else if(intcand_sec == "MV"){
							if (!cand_selection_no.match(onlynumerics)) {
								e_error = 1;
								$('.cand_selection_no').html('Enter Number only use Numeric values, Check again.');
							} else {
								$('.cand_selection_no').html('');
		...
		if (catg_counter == "" || parseInt(catg_counter) <= 0) {
			error_message = error_message + "<br/>Category Section missing, Check Again.";
		}
		if (adv_temp_intvno == "") {
			error_message = error_message + "<br/>AUTOGEN ID missing, Refresh the page";
		}
