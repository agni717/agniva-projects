...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
		  		Existing Candidate - Interview Section List
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Existing Candidate - Interview Section List</li>
          </ol>
        </section>
          ...
          <div class="row">
		    ...
		    <?php $this->session->unset_userdata('e_error'); } ?>
              ...
              <div class="box box-warning">
				...
				<div class="col-sm-2">
                    <input style="margin-top:25px;" type="button" id="pa_target_submit"  onclick="goto_submit_button()" class="btn btn-primary pull-center"  value="Submit" />
                </div>
			  ...
			  <?php echo form_close(); ?>
                ...
                <div class="box-body">
					<?php if(!empty($sectionlist)){ ?>
									...
									<div class="col-sm-12">
									<a href="<?php //echo base_url('admincontrol/finalpanel/print_the_finalpanel_lsitsets/'.$searchlist['advno']); ?>" target="_blank" class="btn btn-lg btn-primary">PRINT</a></div>
									</div>-->
							...
							<table class="table table-striped" id="datatable_tab123" width="100%">
								...
								<tbody>
									<?php foreach($sectionlist as $keys=>$quaries)
									{ ?>
									<tr>
										<td><?php echo $keys+1; ?></td>
										<td><?php echo $quaries->catm_name; ?></td>
										<td><?php echo $quaries->shift_name; ?></td>
										<td><?php echo date('d-m-Y',strtotime($quaries->shift_date)); ?></td>
										<td><?php echo $quaries->address_name; ?></td>
										<td><?php echo date('h:i A',strtotime($quaries->shift_start_time)).' To '.date('h:i A',strtotime($quaries->shift_end_time)); ?></td>
										<td><?php echo $quaries->idm_cat_tableno." [";
										for($ii = 0; $ii < $quaries->idm_cat_tableno; $ii++){
											if($ii > 0){
												echo ", ";
											}
											$eacttab = $quaries->idm_tab_start_count + $ii;
											echo "Table No. ".$eacttab;
										}
										echo "]";
										?></td>
										<td><?php echo $quaries->idm_shift_tab_each; ?></td>
										<td><?php //print_r($quaries); ?><?php if($quaries->shift_date > date('Y-m-d')){ ?><a href="<?php echo base_url('admincontrol/interview/check_addmore_section_candidates/'.$quaries->idm_adv_no.'/'.$quaries->idm_id); ?>" class="btn-sm btn-primary">ADD MORE</a><?php } ?></td>
									</tr>	
									<?php } ?>
								</tbody>
							</table>
