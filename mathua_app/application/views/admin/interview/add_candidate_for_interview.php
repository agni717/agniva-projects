		    ...
		    <?php $this->session->unset_userdata('e_error'); } ?>
              ...
              <div class="box box-warning">
					...
					<div class="form-group">
						...
						<div>
							<div class="radio">
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<label>
									<input type="radio" name="has_cand_main" id="has_cand_main2" value="EC" autocomplete="off"> Except Courtcase
								</label>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<label>
									<input type="radio" name="has_cand_main" id="has_cand_main3" value="IC" autocomplete="off"> Only Courtcase
								</label>
							</div>
				...
				<div class="col-sm-offset-1 col-sm-10">
					<strong><u>Post Category Wise Data </u>:-</strong><br/>
					<table width="100%" class="table">
						...
						<tbody class="setall_experiences">
							<tr>
								<td style="width:23%;">
									<select class="form-control selectpicker" name="venueno" id="venueno" onchange="goto_check_totaltab();" autocomplete="off" disabled>
									<option value="">---Select---</option>
								...
								<td style="width:24%;">
									<select class="form-control" name="shift_name" id="shift_name" autocomplete="off" disabled>
										<option value="">---Select---</option>
									</select>
								...
								<td style="width:15%;">
				    				<input type="text" class="form-control" name="table_stn" id="table_stn" placeholder="No. of Per Table Strength" autocomplete="off" disabled />
