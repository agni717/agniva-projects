...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
		  		Interview Panel Candidate list
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Interview Panel Candidate list</li>
          </ol>
        </section>
		    ...
		    <?php $this->session->unset_userdata('e_error'); } ?>
              ...
              <div class="box box-warning">
				...
				<div class="col-sm-2">
				    ...
				    <select class="form-control" name="table_exactno" id="table_exactno" autocomplete="off" <?php if(empty($searchlist['table_exactno'])){echo "disabled";}?>>
						<option value="">---Select---</option>
			  ...
			  <?php echo form_close(); ?>
                ...
                <div class="box-body">
								<?php if(!empty($total_checkinglist)){ ?>
									...
									<div class="col-sm-12"><a href="<?php echo base_url().'admincontrol/interview/candidate_tablewise_printdata_set/'.$searchlist['advno'].'/'.$searchlist['advcat_name'].'/'.$searchlist['shift_name'].'/'.$searchlist['table_exactno']; ?>" target="_blank" class="btn btn-primary">PRINT Data</a></div>
									</div>
