...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Add New Frontend User
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">New Frontend User</li>
          </ol>
        </section>
              ...
              <div class="box box-primary">
                ...
                <?php echo form_open_multipart('','class="form-horizontal"'); ?>
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-3">
				      <input type="text" class="form-control" name="f_designation" id="f_designation" placeholder="Enter Designation">
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-3">
				      <input type="text" class="form-control" name="f_username" id="f_username" placeholder="Enter Username">
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <textarea class="form-control" name="f_details" id="f_details" placeholder="Enter Details"></textarea>
		          ...
		          <div class="form-group">
				    <div class="col-sm-offset-3 col-sm-9">
				      <input type="button" onclick="add_frontenduser_submit();" class="btn btn-danger" name="submit" value="Submit" />
...
function add_frontenduser_submit(){
	...
	if(e_error == 1){
		...
		$.ajax({
			method:'POST',
			url:'<?php echo base_url()."admincontrol/panel/add_frontuser_submit"; ?>',
			data:form_data,
			dataType:'JSON',
			contentType: false,
			processData: false,
