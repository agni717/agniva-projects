      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Modify Supplier</li>
          </ol>
        </section>
              ...
              <div class="box box-warning">
                ...
                <?php echo form_open_multipart('','class="form-horizontal" id="myForm"'); ?>
                 <div class="form-group">
				    ...
				    <div class="col-sm-3">
				      <input type="text" class="form-control" name="sp_name" id="sp_name" placeholder="Enter Full Name" value="<?php echo $sp_detail->supp_name; ?>" autocomplete="off" />
				    ...
				    <div class="col-sm-3">
				      <input type="text" class="form-control" name="sp_com_name" id="sp_com_name" placeholder="Enter Company Name" value="<?php echo $sp_detail->supp_company; ?>" autocomplete="off" />
                  ...
                  <div class="form-group">
				    ...
				    <div class="col-sm-3">
				      <input type="text" class="form-control" name="sp_mobile" id="sp_mobile" placeholder="Enter Mobile No." value="<?php echo $sp_detail->supp_mobile; ?>" autocomplete="off" />
				    ...
				    <div class="col-sm-3">
				      <input type="text" class="form-control" name="sp_email" id="sp_email" placeholder="Enter Email-ID" value="<?php echo $sp_detail->supp_email; ?>" autocomplete="off" />
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-8">
				      <textarea class="form-control" name="sp_address" id="sp_address" placeholder="Enter Full Address"><?php echo $sp_detail->supp_address; ?></textarea>
                  ...
                  <div class="form-group">
				    ...
				    <div class="col-sm-3">
				      <input type="text" class="form-control" name="sp_bank" id="sp_bank" placeholder="Enter Bank Name" value="<?php echo $sp_detail->supp_bank; ?>" autocomplete="off" />
				    ...
				    <div class="col-sm-3">
				      <input type="text" class="form-control" name="sp_ac_no" id="sp_ac_no" placeholder="Enter Account Number" value="<?php echo $sp_detail->supp_account_no; ?>" autocomplete="off" />
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-3">
				      <input type="text" class="form-control" name="sp_ifsc" id="sp_ifsc" placeholder="Enter Branch IFSC Code" value="<?php echo $sp_detail->supp_ifsc_code; ?>" autocomplete="off" />
