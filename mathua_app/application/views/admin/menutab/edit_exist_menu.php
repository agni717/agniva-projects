              ...
              <div class="box box-warning">
                ...
                <?php echo form_open_multipart('','class="form-horizontal" id="myForm"'); ?>
                 <div class="form-group">
				    ...
				    <div class="col-sm-3">
				      <input type="text" class="form-control" name="m_name" id="m_name" placeholder="Enter Menu Name" value="<?php echo $m_detail->menu_name; ?>" autocomplete="off" />
				    ...
				    <div class="col-sm-3">
				      <input type="text" class="form-control" name="menu_name_bengali" id="menu_name_bengali" value="<?php echo $m_detail->menu_name_bengali; ?>" placeholder="Enter Menu Bengali Name" autocomplete="off" />
				 ...
				 <div class="form-group">
				    ...
				    <div class="col-sm-6">
				      <input type="text" class="form-control" name="m_link" id="m_link" placeholder="Enter Menu Link" value="<?php echo $m_detail->menu_link; ?>" autocomplete="off" />
				 ...
				 <div class="form-group">
				    ...
				    <div class="col-sm-6">
						<label class="radio-inline"><input class="form-check-input" type="radio" name="menu_new_tab_open" id="menu_new_tab_open_1" value="Y" <?php if($m_detail->menu_new_tab_open == 'Y'){echo 'checked="checked"';} ?> autocomplete="off">YES</label>
						<label class="radio-inline"><input class="form-check-input" type="radio" name="menu_new_tab_open" id="menu_new_tab_open_2" value="N" <?php if($m_detail->menu_new_tab_open == 'N'){echo 'checked="checked"';} ?> autocomplete="off">NO</label>
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-6">
						<label class="radio-inline"><input class="form-check-input" type="radio" name="m_type" id="m_type_1" value="0" <?php if($m_detail->menu_level == 0){echo 'checked="checked"';} ?> autocomplete="off">Primary</label>
						<label class="radio-inline"><input class="form-check-input" type="radio" name="m_type" id="m_type_2" value="1" <?php if($m_detail->menu_level == 1){echo 'checked="checked"';} ?> autocomplete="off">Sub Menu</label>
						<label class="radio-inline"><input class="form-check-input" type="radio" name="m_type" id="m_type_3" value="2" <?php if($m_detail->menu_level == 2){echo 'checked="checked"';} ?> autocomplete="off">Sub-Sub Menu</label>
						<label class="radio-inline"><input class="form-check-input" type="radio" name="m_type" id="m_type_4" value="3" <?php if($m_detail->menu_level == 3){echo 'checked="checked"';} ?> autocomplete="off">Sub-Sub-Sub Menu</label>
						<small class="text-error m_type"><?php echo form_error('m_type'); ?></small>
				    </div>
				  </div>
					<div class="form-group super_menu" id="super_menu" <?php if($m_detail->menu_level == 1){echo 'style="display:block;"';}else{echo 'style="display:none;"';} ?>>
						...
						<div class="col-sm-3">
						  <select class="form-control" name="m_primary" id="m_primary">
							...
							<option value="<?php echo $main_menu->menu_id; ?>" <?php if($m_detail->parent_menu == $main_menu->menu_id){echo 'selected=""';} ?>><?php echo $main_menu->menu_name; ?></option>
							<?php } ?>
						  </select>
						  <small class="text-error m_primary"><?php echo form_error('m_primary'); ?></small>
						</div>
					</div>
					<div class="form-group sub_menu" id="sub_menu" <?php if($m_detail->menu_level == 2){echo 'style="display:block;"';}else{echo 'style="display:none;"';} ?>>
						...
						<div class="col-sm-3">
						  <select class="form-control" name="m_sub" id="m_sub">
							...
							<option value="<?php echo $mainsub_menu->menu_id; ?>" <?php if($m_detail->parent_menu == $mainsub_menu->menu_id){echo 'selected=""';} ?>><?php echo $mainsub_menu->menu_name; ?></option>
							<?php } ?>
						  </select>
						  <small class="text-error m_sub"><?php echo form_error('m_sub'); ?></small>
						</div>
					</div>
					<div class="form-group sub_sub_menu" id="sub_sub_menu" <?php if($m_detail->menu_level == 3){echo 'style="display:block;"';}else{echo 'style="display:none;"';} ?>>
						...
						<div class="col-sm-3">
							<select class="form-control" name="m_sub_sub" id="m_sub_sub">
								...
								<option value="<?php echo $main_subsub_menu->menu_id; ?>" <?php if($m_detail->parent_menu == $main_subsub_menu->menu_id){echo 'selected=""';} ?>><?php echo $main_subsub_menu->menu_name; ?></option>
								<?php } ?>
							</select>
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" class="form-control" name="m_order" id="m_order" value="<?php echo $m_detail->menu_order; ?>" placeholder="Enter Menu Position" autocomplete="off" />
