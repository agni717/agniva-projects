...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
             <?php echo "Add New Recruitment"; ?>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active"> <?php echo "Add New Recruitment"; ?></li>
          </ol>
        </section>
		    ...
		    <?php $this->session->unset_userdata('success'); } ?>
              ...
              <div class="box box-primary">
                ...
                <div class="form-group" >
                  <label class="col-sm-3 control-label text-right">Name of Recruitment<font style="color: red;">*</font></label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="r_name" name="r_name" placeholder="Enter Name of Recruitment" value="<?php echo set_value('r_name'); ?>" autocomplete="off" required />
                  ...
                  <div class="form-group">
				    <div class="col-sm-offset-3 col-sm-3">
						...
						&nbsp;<a href="<?= site_url('admincontrol/masterdata/recruitment_list') ?>" class="btn btn-danger">Cancel</a>
				    </div>
				  </div>
