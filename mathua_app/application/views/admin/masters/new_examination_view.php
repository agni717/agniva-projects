...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      <?php echo "Add New Qualification"; ?>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active"> <?php echo "Add New Qualification"; ?></li>
    </ol>
  </section>
        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-3">
                <input type="text" class="form-control" id="ex_name" name="ex_name" placeholder="Enter Name of Qualification" value="<?php echo set_value('ex_name'); ?>" autocomplete="off" required />
              ...
              <div class="col-sm-3">
                <select class="form-control" name="r_name" id="r_name" autocomplete="off">
                  ...
                  <?php foreach ($rec_list as $rms) { ?>
                    <option value="<?php echo $rms->rm_id; ?>"><?php echo $rms->rm_name; ?></option>
                  <?php } ?>
                </select>
