...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      <?php echo "Edit Qualification"; ?>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active"> <?php echo "Edit Qualification"; ?></li>
    </ol>
  </section>
        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              <label class="col-sm-3 control-label text-right">Name of Qualification<font style="color: red;">*</font></label>
              <div class="col-sm-3">
                <input type="text" class="form-control" id="ex_name" name="ex_name" placeholder="Enter Name of Qualification" value="<?php echo $rec_detail->qm_name; ?>" autocomplete="off" required />
                <small class="text-error"><?php echo form_error('ex_name'); ?></small>
              </div>
              ...
              <div class="col-sm-3">
                <select class="form-control" name="r_name" id="r_name" autocomplete="off">
                  ...
                  <?php foreach ($rec_list as $rms) { ?>
                    <option value="<?php echo $rms->rm_id; ?>" <?php if ($rec_detail->qm_r_master == $rms->rm_id) { echo "selected";} ?>><?php echo $rms->rm_name; ?></option>
                  <?php } ?>
                </select>
            ...
            <div class="form-group">
              <div class="col-sm-offset-3 col-sm-2">
                ...
                &nbsp;<a href="<?= site_url('admincontrol/masterdata/examination_list') ?>" class="btn btn-danger">Cancel</a>
              </div>
            </div>
