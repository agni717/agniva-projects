...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
		  InterView Rules List
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">InterView Rules List</li>
          </ol>
        </section>
              ...
              <div class="box box-warning">
				...
				<!-- <div class="box-footer clearfix no-border">
                  ...
                  <table class="table table-striped" id="datatable_tab" width="100%">
                  	...
                  	<tbody>
                  		<?php foreach($rule_list as $keys=>$users)
                  		{ ?>
                  		<tr>
                  			<td><?php echo ($keys + 1); ?></td>
                  			<td><?php echo $users->rm_details; ?></td>
							<td><?php echo $users->rm_order; ?></td>
							<td><?php if($users->rm_status == 1){ ?>
							  ...
							  <?php } ?></td>
                  			<td>
                  				<a href="<?php echo base_url().'admincontrol/masterdata/modify_interviewrule/'.$users->rm_id; ?>" title="Edit Record"><i class="fa fa-edit text-warning"></i></a>
                  				<?php if($users->rm_status == 1){ ?>	
                  				<a href="<?php echo base_url().'admincontrol/masterdata/lock_interviewrules/'.$users->rm_id; ?>" title="Lock Record"><i class="fa fa-unlock text-warning"></i></a>
                  				<?php } else { ?>
								<a href="<?php echo base_url().'admincontrol/masterdata/unlock_interviewrules/'.$users->rm_id; ?>" title="Unock Record"><i class="fa fa-lock text-warning"></i></a>
								<?php } ?>
