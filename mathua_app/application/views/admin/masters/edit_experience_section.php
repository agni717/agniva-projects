...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
             <?php echo "Modify Experience Section"; ?>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active"> <?php echo "Modify Experience Section"; ?></li>
          </ol>
        </section>
		    ...
		    <?php $this->session->unset_userdata('success'); } ?>
              ...
              <div class="box box-primary">
                ...
                <div class="form-group" >
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="e_name" name="e_name" placeholder="Enter Name of Experience" value="<?php echo $exp_detail->expset_name; ?>" autocomplete="off" required />
                  ...
                  <div class="col-sm-3">
                    <select class="form-control" id="e_type" name="e_type" autocomplete="off" required>
                      ...
                      <option value="Government" <?php //if($exp_detail->expset_type == "Government"){echo "selected";} ?>>Government</option>
                      <option value="Private" <?php //if($exp_detail->expset_type == "Private"){echo "selected";} ?>>Private</option>
                    </select>
