...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
             <?php echo "Edit Recruitment"; ?>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active"> <?php echo "Edit Recruitment"; ?></li>
          </ol>
        </section>
		    ...
		    <?php $this->session->unset_userdata('success'); } ?>
              ...
              <div class="box box-primary">
                ...
                <div class="form-group" >
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="r_name" name="r_name" placeholder="Enter Name of Recruitment" value="<?php echo $rec_detail->rm_name; ?>" autocomplete="off" required />
