...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
             <?php echo "Add New Discipline"; ?>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active"> <?php echo "Add New Discipline"; ?></li>
          </ol>
        </section>
              ...
              <div class="box box-primary">
                ...
                <?php echo form_open_multipart('','class="form-horizontal"'); ?>
                  <div class="form-group" >
					  ...
					  <div class="col-sm-3">
						<input type="text" class="form-control" id="d_name" name="d_name" placeholder="Enter Discipline Name" value="<?php echo set_value('d_name'); ?>" autocomplete="off" required />
