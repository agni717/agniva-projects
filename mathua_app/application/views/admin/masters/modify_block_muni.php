...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      <?php echo "Modify Block/ Municipality"; ?>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active"> <?php echo "Modify Block/ Municipality"; ?></li>
    </ol>
  </section>
        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
              ...
              <div class="col-sm-3">
                <select class="form-control" name="d_name" id="d_name" autocomplete="off" required>
                  ...
                  <?php foreach ($dist_list as $distss) { ?>
                    <option value="<?php echo $distss->district_code; ?>" <?php if($distss->district_code == $bm_detail->district_id){echo 'selected="selceted"';} ?>><?php echo $distss->district_name; ?></option>
                  <?php } ?>
                </select>
              ...
              <div class="col-sm-3">
                <select class="form-control" name="s_name" id="s_name" autocomplete="off">
                  ...
                  <?php foreach ($subdiv_list as $subss) { ?>
                    <option value="<?php echo $subss->subdiv_id; ?>" <?php if($subss->subdiv_id == $bm_detail->subd_id){echo 'selected="selceted"';} ?>><?php echo $subss->subdiv_name; ?></option>
                  <?php } ?>
                </select>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-3">
                <input type="text" class="form-control" id="bm_name" name="bm_name" placeholder="Enter Name of Block/ Municipality" value="<?php echo $bm_detail->block_name; ?>" autocomplete="off" required />
              ...
              <div class="col-sm-3">
                <select class="form-control" name="bm_type" id="bm_type" autocomplete="off" required>
                  <option value="">---Select---</option>
                  <option value="Block" <?php if($bm_detail->block_type == "Block"){echo 'selected="selceted"';} ?>>Block</option>
                  <option value="Municipality" <?php if($bm_detail->block_type == "Municipality"){echo 'selected="selceted"';} ?>>Municipality</option>
                </select>
