...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
             <?php echo "Modify Age Relaxation"; ?>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active"> <?php echo "Modify Age Relaxation"; ?></li>
          </ol>
        </section>
		    ...
		    <?php $this->session->unset_userdata('success'); } ?>
              ...
              <div class="box box-primary">
                ...
                <div class="form-group" >
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="ageset_name" name="ageset_name" placeholder="Enter Name of Age Relaxation" value="<?php echo $age_detail->caste_name; ?>" autocomplete="off" required />
