...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      <?php echo "Add New Police Station"; ?>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active"> <?php echo "Add New Police Station"; ?></li>
    </ol>
  </section>
        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-3">
                <input type="text" class="form-control" id="p_name" name="p_name" placeholder="Enter Name of Police Station" value="<?php echo set_value('p_name'); ?>" autocomplete="off" required />
