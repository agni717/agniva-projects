...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      <?php echo "Add New InterView Rule"; ?>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active"> <?php echo "Add New InterView Rule"; ?></li>
    </ol>
  </section>
        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control" id="rule_name" name="rule_name" placeholder="Enter Rule Details" value="<?php echo set_value('rule_name'); ?>" autocomplete="off" required />
            ...
            <div class="form-group">
              ...
              <div class="col-sm-3">
                <input type="text" class="form-control" id="rule_order" name="rule_order" placeholder="Enter Rule Order" value="0" autocomplete="off" required />
