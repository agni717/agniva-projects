...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      <?php echo "Add New Venue"; ?>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active"> <?php echo "Add New Venue"; ?></li>
    </ol>
  </section>
        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control" id="v_name" name="v_name" placeholder="Enter Address of Venue" value="<?php echo set_value('v_name'); ?>" autocomplete="off" required />
            ...
            <div class="form-group">
              ...
              <div class="col-sm-2">
                <input type="text" class="form-control" name="t_no" id="t_no" placeholder="Enter Table no." autocomplete="off" required />
                <small class="text-error"><?php //echo form_error('t_no'); ?></small>
              </div>-->
              <label class="col-sm-3 control-label text-right">Select District<font style="color: red;">*</font></label>
              <div class="col-sm-3">
