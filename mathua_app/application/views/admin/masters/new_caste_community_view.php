...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
             <?php echo "Add New Caste Community"; ?>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active"> <?php echo "Add New Caste Community"; ?></li>
          </ol>
        </section>
              ...
              <div class="box box-primary">
                ...
                <?php echo form_open_multipart('','class="form-horizontal"'); ?>
                  <div class="form-group">
					  ...
					  <div class="col-sm-3">
						<input type="text" class="form-control" id="cdtl_name" name="cdtl_name" placeholder="Enter Community Name" value="<?php echo set_value('cdtl_name'); ?>" autocomplete="off" required />
				    ...
				    <div class="col-sm-3">
				       <select class="form-control" name="c_name" id="c_name" autocomplete="off">
                        ...
                        <option value="<?php echo $casts->caste_id; ?>"><?php echo $casts->caste_name; ?></option>
                        <?php } ?>
                       </select>
