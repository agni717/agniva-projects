...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      <?php echo "Modify Sub-Division"; ?>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active"> <?php echo "Modify Sub-Division"; ?></li>
    </ol>
  </section>
          ...
          <div class="box-body">
              ...
              <div class="col-sm-3">
                <select class="form-control" name="d_name" id="d_name" autocomplete="off" required>
                  ...
                  <?php foreach ($dist_list as $distss) { ?>
                    <option value="<?php echo $distss->district_code; ?>" <?php if($distss->district_code == $s_detail->subdiv_district){echo 'selected="selceted"';} ?>><?php echo $distss->district_name; ?></option>
                  <?php } ?>
                </select>
                <small class="text-error"><?php echo form_error('d_name'); ?></small>
              </div>
              <label class="col-sm-2 control-label text-right">Name of Sub-Division<font style="color: red;">*</font></label>
              <div class="col-sm-3">
                <input type="text" class="form-control" id="s_name" name="s_name" placeholder="Enter Name of Sub-Division" value="<?php echo $s_detail->subdiv_name; ?>" autocomplete="off" required />
            ...
            <div class="form-group">
              <div class="col-sm-offset-3 col-sm-2">
                ...
                &nbsp;<a href="<?= site_url('admincontrol/masterdata/subdivision_list') ?>" class="btn btn-danger">Cancel</a>
              </div>
            </div>
