...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      <?php echo "Modify Police Station"; ?>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active"> <?php echo "Modify Police Station"; ?></li>
    </ol>
  </section>
              ...
              <div class="col-sm-3">
                <select class="form-control" name="d_name" id="d_name" autocomplete="off" required>
                  ...
                  <?php foreach ($dist_list as $distss) { ?>
                    <option value="<?php echo $distss->district_code; ?>" <?php if($distss->district_code == $ps_detail->ps_dist_master){echo 'selected="selceted"';} ?>><?php echo $distss->district_name; ?></option>
                  <?php } ?>
                </select>
                <small class="text-error"><?php echo form_error('d_name'); ?></small>
              </div>
              <label class="col-sm-2 control-label text-right">Name of Police Station<font style="color: red;">*</font></label>
              <div class="col-sm-3">
                <input type="text" class="form-control" id="p_name" name="p_name" placeholder="Enter Name of Police Station" value="<?php echo $ps_detail->ps_name; ?>" autocomplete="off" required />
                <small class="text-error"><?php echo form_error('p_name'); ?></small>
              </div>
            </div>
            <div class="form-group">
              <div class="col-sm-offset-3 col-sm-2">
                <input type="submit" class="btn btn-primary" name="submit" value="Submit" width="60px;" />
                &nbsp;<a href="<?= site_url('admincontrol/masterdata/policestation_list') ?>" class="btn btn-danger">Cancel</a>
              </div>
            </div>
