...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
             <?php echo "Add New Caste Issuing Authority"; ?>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active"> <?php echo "Add New Caste Issuing Authority"; ?></li>
          </ol>
        </section>
		    ...
		    <?php $this->session->unset_userdata('success'); } ?>
              ...
              <div class="box box-primary">
                ...
                <div class="form-group" >
                  <label class="col-sm-3 control-label text-right">Name of Issuing Authority<font style="color: red;">*</font></label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="cia_name" name="cia_name" placeholder="Enter Name of Issuing Authority" value="<?php echo set_value('cia_name'); ?>" autocomplete="off" required />
                    <small class="text-error"><?php echo form_error('cia_name'); ?></small>
                  </div>
				</div>  
                  <div class="form-group">
				    <div class="col-sm-offset-3 col-sm-2">
				      <input type="submit" class="btn btn-primary" name="submit" value="Submit" width="60px;" />
                      &nbsp;<a href="<?= site_url('admincontrol/masterdata/caste_issuing_authority_list') ?>" class="btn btn-danger">Cancel</a>
				    </div>
				  </div>
