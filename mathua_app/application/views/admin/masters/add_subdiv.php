...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      <?php echo "Add New Sub-Division"; ?>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active"> <?php echo "Add New Sub-Division"; ?></li>
    </ol>
  </section>
        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-3">
                <input type="text" class="form-control" id="s_name" name="s_name" placeholder="Enter Name of Sub-Division" value="<?php echo set_value('s_name'); ?>" autocomplete="off" required />
