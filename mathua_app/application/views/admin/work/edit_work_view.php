          ...
          <div class="row">
        	...
        	<?php } ?>
              ...
              <div class="box box-warning">
                ...
                <?php echo form_open_multipart(base_url().'admincontrol/panel/edit_work/'.$work_detail->mw_id,'class="form-horizontal" id="myForm"'); ?>
                 <div class="form-group">
				    ...
				    <div class="col-sm-2">
						<select class="form-control" name="f_year" id="f_year">
							...
							for($i=$prev_yr;$i<$adv_yr;$i++){ 
								$tmp = $i + 1; 
								$tmpname = "20".$i."-".$tmp; ?>
								<option value="<?php echo $tmpname; ?>" <?php if($work_detail->mw_year == $tmpname){ echo "selected";} ?>><?php echo $tmpname; ?></option>
							<?php }	?>
				      	</select>
				    ...
				    <div class="col-sm-5">
						<input type="text" class="form-control" name="w_name" id="w_name" placeholder="Enter Name of Work" autocomplete="off" value="<?php echo $work_detail->mw_name; ?>" />
				 ...
				 <div class="form-group">
				    ...
				    <div class="col-sm-4">
						<input type="text" class="form-control" name="w_loc" id="w_loc" placeholder="Enter Location of the scheme" autocomplete="off" value="<?php echo $work_detail->mw_location; ?>" />
				 ...
				 <div class="form-group">
				    ...
				    <div class="col-sm-3">
				      <select class="form-control" name="w_fund" id="w_fund" onchange="goto_check_fund();">
						...
						<option value="<?php echo $funds->fs_id; ?>" <?php if($work_detail->mw_fund_source == $funds->fs_id){ echo "selected";} ?>><?php echo $funds->fs_name; ?></option>
						<?php } ?>
                  ...
                  <div class="form-group">
				    ...
				    <div class="col-sm-3">
				      <select class="form-control" name="w_sector" id="w_sector" onchange="goto_check_sector();">
						...
						<option value="<?php echo $sectors->ws_id; ?>" <?php if($work_detail->mw_sector == $sectors->ws_id){ echo "selected";} ?>><?php echo $sectors->ws_name; ?></option>
						<?php } ?>
						<option value="Others">Others</option>
				      </select>
                  ...
                  <div class="form-group">
				  	...
				  	<div class="col-sm-3">
						<div class="radio">
							<label>
							<input type="radio" name="w_t_float" id="w_t_float1" value="Yes" <?php if($work_detail->mw_tender_float == "Yes"){ echo "checked";} ?>> Yes
							</label>
							&nbsp;&nbsp;&nbsp;
							<label>
							<input type="radio" name="w_t_float" id="w_t_float2" value="No" <?php if($work_detail->mw_tender_float == "No"){ echo "checked";} ?>> No
							</label>
						</div>
				  ...
				  <div class="float_tender_tab" <?php if($work_detail->mw_tender_float != "Yes"){ echo  'style="display:none;"';} ?>>
					<div class="form-group">
						<label class="col-sm-2 control-label text-right">Amount of Tender</label>
						<div class="col-sm-2">
						<input type="text" class="form-control" name="w_t_amount" id="w_t_amount" placeholder="Enter Amount of Tender" autocomplete="off" value="<?php echo $work_detail->mw_tender_amount; ?>" />
						...
						<div class="col-sm-2">
						<input type="text" class="form-control" name="w_t_date" id="w_t_date" placeholder="DD-MM-YYYY" autocomplete="off" value="<?php echo date('d-m-Y',strtotime($work_detail->mw_tender_date)); ?>" />
						...
						<option value="">---Select---</option>
						<option value="E-tender" <?php if($work_detail->mw_tender_mode == "E-tender"){ echo "selected";} ?>>E-tender</option>
						<option value="Offline" <?php if($work_detail->mw_tender_mode == "Offline"){ echo "selected";} ?>>Offline</option>
						</select>
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
						<input type="text" class="form-control" name="w_nitno" id="w_nitno" placeholder="Enter NIT No." autocomplete="off" value="<?php echo $work_detail->mw_nit_no; ?>" />
						<small class="text-error w_nitno"><?php echo form_error('w_nitno'); ?></small>
						</div>
						
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label text-right">Current NIT Document</label>
						<div class="col-sm-4 text-left" style="margin-top:7px;"><a href="<?php echo base_url().'upload_file/nit_doc/'.$work_detail->mw_nit_doc; ?>" target="_blank"><?php echo $work_detail->mw_nit_doc; ?></a></div>
						
						<label class="col-sm-3 control-label text-right">Want to Change NIT Document</label>
						<div class="col-sm-3">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<div class="radio">
								<label>
								<input type="radio" name="w_t_mature" id="w_t_mature1" value="Yes" <?php if($work_detail->mw_tender_mature == "Yes"){ echo "checked";} ?>> Yes
								</label>
								&nbsp;&nbsp;&nbsp;
								<label>
								<input type="radio" name="w_t_mature" id="w_t_mature2" value="No" <?php if($work_detail->mw_tender_mature == "No"){ echo "checked";} ?>> No
								</label>
							</div>
						...
						<div class="col-sm-3">
						<input type="text" class="form-control" name="w_order_date" id="w_order_date" placeholder="DD-MM-YYYY" autocomplete="off" value="<?php echo date('d-m-Y',strtotime($work_detail->mw_order_issue_date)); ?>" />
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
						<input type="text" class="form-control" name="w_award_amount" id="w_award_amount" placeholder="Enter Amount of Awarded Cost" autocomplete="off" value="<?php echo $work_detail->mw_award_cost; ?>" />
						<small class="text-error w_award_amount"><?php echo form_error('w_award_amount'); ?></small>
						</div>
						
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label text-right">Current WorkOrder Copy</label>
						<div class="col-sm-4 text-left" style="margin-top:7px;"><a href="<?php echo base_url().'upload_file/worder_doc/'.$work_detail->mw_workorder_doc; ?>" target="_blank"><?php echo $work_detail->mw_workorder_doc; ?></a></div>
						
						<label class="col-sm-3 control-label text-right">Want to Change WorkOrder Copy</label>
						<div class="col-sm-3">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
						<input type="text" class="form-control" name="w_agency_name" id="w_agency_name" placeholder="Enter Name of Agency/contractor" autocomplete="off" value="<?php echo $work_detail->mw_agency_name; ?>" />
						...
						<div class="col-sm-3">
						<input type="text" class="form-control" name="w_agency_mobile" id="w_agency_mobile" placeholder="Enter Mobile No." autocomplete="off" value="<?php echo $work_detail->mw_agency_mobile; ?>" />
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
						<input type="text" class="form-control" name="w_agency_gst" id="w_agency_gst" placeholder="Enter GST No." autocomplete="off" value="<?php echo $work_detail->mw_agency_gst; ?>" />
						...
						<div class="col-sm-3">
						<input type="text" class="form-control" name="w_emd_amount" id="w_emd_amount" placeholder="Enter EMD Amount" autocomplete="off" value="<?php echo $work_detail->mw_emd_amount; ?>" />
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
						<input type="text" class="form-control" name="w_com_date" id="w_com_date" placeholder="DD-MM-YYYY" autocomplete="off" value="<?php echo date('d-m-Y',strtotime($work_detail->mw_commence_date)); ?>" />
						...
						<div class="col-sm-3">
						<input type="text" class="form-control" name="w_tent_date" id="w_tent_date" placeholder="DD-MM-YYYY" autocomplete="off" value="<?php echo date('d-m-Y',strtotime($work_detail->mw_tentative_date)); ?>" />
