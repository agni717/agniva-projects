      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Allocate New Work</li>
          </ol>
        </section>
        	...
        	<?php } ?>
              ...
              <div class="box box-warning">
                <div class="box-header">
                  ...
                  <h3 class="box-title">Allocate New Work</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                ...
                <?php echo form_open_multipart('','class="form-horizontal" id="myForm"'); ?>
                 <div class="form-group">
				    ...
				    <div class="col-sm-2">
						<select class="form-control" name="f_year" id="f_year" onchange="goto_check_work();">
							<option value="">---Select---</option>
							<?php foreach($yr_list as $years){ ?>
								<option value="<?php echo $years->mw_year; ?>"><?php echo $years->mw_year; ?></option>
							<?php }	?>
				      	</select>
				    ...
				    <div class="col-sm-5">
						<select class="form-control" name="w_name" id="w_name" disabled>
							<option value="">---Select---</option>
				      	</select>
				 ...
				 <div class="form-group">
				    ...
				    <div class="col-sm-3">
				      <select class="form-control" name="w_ae" id="w_ae">
						...
						<option value="<?php echo $ae_user->u_id; ?>"><?php echo $ae_user->firstname.' '.$ae_user->lastname.' ('.$ae_user->email.')'; ?></option>
						<?php } ?>
					  </select>
				    ...
				    <div class="col-sm-3">
				      <select class="form-control" name="w_sae" id="w_sae">
						...
						<option value="<?php echo $sae_user->u_id; ?>"><?php echo $sae_user->firstname.' '.$sae_user->lastname.' ('.$sae_user->email.')'; ?></option>
						<?php } ?>
				      </select>
...
<script type="text/javascript">
	...
	function gotoclclickbutton(){
		...
		if(w_name == ""){
			...
			if(!w_name.match(alphaletters_spaces)){
				e_error = 1;
				$('.w_name').html('Name of Work not use special carecters, Check again.');
			}else{
				$('.w_name').html('');
			}	
		}
