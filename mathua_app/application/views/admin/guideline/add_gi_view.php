      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Add New Guideline-Instruction</li>
          </ol>
        </section>
        	...
        	<?php } ?>
              ...
              <div class="box box-warning">
                <div class="box-header">
                  ...
                  <h3 class="box-title">Add New Guideline-Instruction</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                ...
                <?php echo form_open_multipart('','class="form-horizontal" id="myForm"'); ?>
                 <div class="form-group">
				    ...
				    <div class="col-sm-6">
						<label class="radio-inline"><input class="form-check-input" type="radio" name="rec_type" id="rec_type_1" value="1" <?php echo set_radio('rec_type', '1'); ?> autocomplete="off">Guideline</label>
						<label class="radio-inline"><input class="form-check-input" type="radio" name="rec_type" id="rec_type_2" value="2" <?php echo set_radio('rec_type', '2'); ?> autocomplete="off">Instruction</label>
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-6">
				      <input type="text" class="form-control" name="rec_title" id="rec_title" placeholder="Enter Record Title" value="<?php echo set_value('rec_title'); ?>" autocomplete="off" />
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-8">
				      <textarea class="form-control" name="rec_details" id="rec_details" placeholder="Enter Record Details"><?php echo set_value('rec_details'); ?></textarea>
				      <small class="text-error rec_details"><?php echo form_error('rec_details'); ?></small>
				    </div>
				  </div>
                  <div class="form-group">
					<label class="col-sm-3 control-label text-right">Upload Document<font style="color: red;">*</font></label>
				    <div class="col-sm-6">
				 ...
				 <div class="form-group">
				    ...
				    <div class="col-sm-3">
				      <input type="text" class="form-control" name="rec_order" id="rec_order" placeholder="Enter Record Order" value="<?php echo set_value('rec_order'); ?>" autocomplete="off" />
...
<script type="text/javascript">
	...
	function gotoclclickbutton(){
		...
		if(document.getElementById("userfile").files.length == 0){
			e_error = 1;
			$('.userfile').html('Document is Required.');
		}else{
