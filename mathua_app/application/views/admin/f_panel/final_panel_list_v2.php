              ...
              <div class="box box-warning">
				...
				<div class="col-sm-3">
				  <div class="form-group">
					...
					<input class="form-control" name="lim_start" id="lim_start" value="<?php if(!empty($searchlist['lim_start'])){echo $searchlist['lim_start'];} ?>" autocomplete="off" />
					<small class="text-error lim_start"><?php echo form_error('lim_start'); ?></small>
				  </div>
				</div>
				<div class="col-sm-3">
				  <div class="form-group">
					<label>Total Count</label>
					<input class="form-control" name="lim_end" id="lim_end" value="<?php if(!empty($searchlist['lim_end'])){echo $searchlist['lim_end'];} ?>" autocomplete="off" />
					<small class="text-error lim_end"><?php echo form_error('lim_end'); ?></small>
				  </div>
				</div>
			  ...
			  <?php echo form_close(); ?>
                ...
                <div class="box-body">
					<?php if(!empty($meritlist)){ ?>
									...
									<div class="col-sm-12"><a href="<?php echo base_url('admincontrol/finalpanel/print_the_finalpanel_set2_section_lsits/'.$searchlist['advno'].'/'.$searchlist['advcat_name'].'/'.$searchlist['gen_set'].'/'.$searchlist['lim_start'].'/'.$searchlist['lim_end']); ?>" target="_blank" class="btn btn-lg btn-primary">PRINT 2</a></div>
									</div>
							...
							<table class="table table-striped" id="datatable_tab123" width="100%">
								...
								<tbody>
									...
									{ ?>
									<tr>
										<td><?php echo $keys+$searchlist['lim_start']+1; ?></td>
