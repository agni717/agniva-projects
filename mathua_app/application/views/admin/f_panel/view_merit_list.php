...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
		  		Candidate - Merit List
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Candidate Merit List</li>
          </ol>
        </section>
			  ...
			  <?php echo form_close(); ?>
                ...
                <div class="box-body">
					<?php if(!empty($meritlist)){ ?>
									...
									<div class="col-sm-12"><a href="<?php echo base_url('admincontrol/finalpanel/htmlview_meritlist_candidate_v2/'.$searchlist['advno'].'/'.$searchlist['advcat_name'].'/'.$searchlist['gen_set']); ?>" target="_blank" class="btn btn-lg btn-primary">PRINT COPY</a>&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url('admincontrol/finalpanel/print_meritlist_candidate/'.$searchlist['advno'].'/'.$searchlist['advcat_name'].'/'.$searchlist['gen_set']); ?>" target="_blank" class="btn btn-lg btn-primary">PRINT</a></div>
									</div>
