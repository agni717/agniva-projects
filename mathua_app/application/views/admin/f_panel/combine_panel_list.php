...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
		  		Candidate - Combine Panel List
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Candidate - Combine Panel List</li>
          </ol>
        </section>
			  ...
			  <?php echo form_close(); ?>
                ...
                <div class="box-body">
					<?php if(!empty($meritlist)){ ?>
									...
									<div class="col-sm-12"><a href="<?php echo base_url('admincontrol/finalpanel/htmlview_the_combinepanel_section_lsits/'.$searchlist['advno'].'/'.$searchlist['advcat_name']); ?>" target="_blank" class="btn btn-lg btn-primary">PRINT COPY</a>&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url('admincontrol/finalpanel/print_the_combinepanel_lsitsets/'.$searchlist['advno'].'/'.$searchlist['advcat_name']); ?>" target="_blank" class="btn btn-lg btn-primary">PRINT</a></div>
									</div>
							...
							<table class="table table-striped" id="datatable_tab123" width="100%">
								...
								<tbody>
									...
									<tr>
										...
										<td><?php echo $quaries->section_name; ?></td>
									</tr>	
									<?php } ?>
								</tbody>
							</table>
