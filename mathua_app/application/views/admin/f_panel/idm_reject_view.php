...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
		  Application Number - <?php echo $doc_detail->idm_ucode; ?>
          </h1>
          <ol class="breadcrumb">
        ...
        <?php if (isset($error)) { ?>
            ...
            <label class="col-sm-3 control-label text-right">Reason of Rejection</label>
				    <div class="col-sm-9">
              <input type="hidden" name="reject_id" id="reject_id" value="<?php echo $doc_detail->idm_id; ?>" />
				      ...
				      <small class="text-error reject_details"><?php echo form_error('reject_details'); ?></small>
						...
						<div class="form-group">
							<div class="col-sm-offset-4 col-sm-8">
								...
								&nbsp;<a href="<?= site_url('admincontrol/movement/idm_application_list') ?>" class="btn btn-warning">Cancel</a>
							</div>
						</div>
						<?php form_close(); ?>						
					</div>
