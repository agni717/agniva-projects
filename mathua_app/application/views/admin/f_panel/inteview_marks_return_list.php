...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
		  Interview Marks Return List
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Interview Marks Return List</li>
          </ol>
        </section>
		    ...
		    <?php $this->session->unset_userdata('e_error'); } ?>
              ...
              <div class="box box-warning">
                ...
                <div class="box-body">
                  ...
                  <table class="table" id="datatable_tab" width="100%">
	                  <thead style="font-weight: bold;">
					  		<td>Sl. No.</td>
					  		<td>Candidate Reg No.</td>
							<td>Candidate Name</td>
							<td>Candidate Mobile</td>
							<td>Checker Return Comments</td>
							<td>Action</td>
					  </thead>
                  	<tbody>
                  		<?php
						  foreach($return_listset as $keys=>$users)
                  		{ ?>
                  		<tr>
						  	<td><?php echo ($keys + 1); ?></td>
                  			<td><?php echo $users->invw_cand_regno; ?></td>
							<td><?php echo $users->f_full_name; ?></td>
							<td><?php echo $users->f_mobile; ?></td>
                  			<td><?php echo $users->invw_msg_return; ?></td>
							<td style="width:100px;"><a class="btn-sm btn-danger" href="<?php echo base_url().'admincontrol/movement/modify_returndata_inthecheckerend/'.$users->invw_id; ?>" title="Modify Interview Marks">Modify</a></td>
                  		</tr>	
						<?php } ?>
                  	</tbody>
                  </table>
