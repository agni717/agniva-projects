...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
		  		Candidate - Merit & Panel List Deletion
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Candidate Merit & Panel List Deletion</li>
          </ol>
        </section>
...
<script type="text/javascript">
	...
	function goto_submit_button(){
		...
		if(e_error == 1){
			...
			//alert(rehash);
			var conf_answer = confirm("Are you sure you want to Delete the Merit & Panel Data for that Advertisement Category?")
			if (conf_answer) {
				$("#form123").submit();
			}else {
				$('.div_roller_total').fadeOut();
