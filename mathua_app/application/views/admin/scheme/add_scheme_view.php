                    ...
                    <div class="row">
                        <div class="col-lg-12">
                           <div class="form-row control-group">
                              <div class="form-group col-lg-12">
                                 ...
                                 <input type="text" class="form-control" name="sc_name" id="sc_name" placeholder="Enter Scheme Name" autocomplete="off" />
								 <small class="text-error sc_name"><?php echo form_error('sc_name'); ?></small>
                              </div>
                              <div class="form-group col-lg-12">
                                 <label>Scheme Details</label>
                                 <textarea class="form-control" name="sc_detail" id="sc_detail" rows="2" placeholder="Enter Scheme Details" autocomplete="off"></textarea>
								 <small class="text-error sc_detail"><?php echo form_error('sc_detail'); ?></small>
                              </div>
                              <!-- <div class="form-group col-lg-12">
                                 <label>Scheme Amount</label>
                                 <input type="text" class="form-control" name="sc_amount" id="sc_amount" placeholder="Enter Scheme Amount" autocomplete="off" />
								 <small class="text-error sc_amount"><?php //echo form_error('sc_amount'); ?></small>
                              </div>
                              <div class="form-group col-lg-12">
                                 <label>Number of Installment</label>
                                 <input type="text" class="form-control" name="sc_installment_no" id="sc_installment_no" placeholder="Enter Scheme Amount" autocomplete="off" />
								 <small class="text-error sc_installment_no"><?php //echo form_error('sc_installment_no'); ?></small>
                              </div>
                              <div class="form-group col-lg-12">
                                 <label>Reference Number</label>
                                 <input type="text" class="form-control" name="sc_ref_no" id="sc_ref_no" placeholder="Enter Scheme Reference Number" autocomplete="off" />
								 <small class="text-error sc_ref_no"><?php //echo form_error('sc_ref_no'); ?></small>
                              </div>
                              <div class="form-group col-lg-12">
                                 <label>Date</label>
                                 <input type="date" class="form-control" name="sc_date" id="sc_date" autocomplete="off" />
                        ...
                        <!-- <div class="col-lg-6"> -->
                           	<!-- <div class="col-lg-12 form-group">
								<label>Scheme Wise Amount Allotment </label>
							</div> -->
                           	<!-- <div class="col-lg-12">
                              	<div class="row">
									<div class="col-lg-12">
										<div style="padding:15px;border: #aaa 1px solid;">
											<table class="slav_tabs">
												...
												<tr class="slav_set_1">
													<td><input type="hidden" class="form-control" name="q_slnum[]" id="q_slnum1" value="1" />1</td>
						...
						<div class="form-group">
							<div class="col-sm-12">
								...
								&nbsp;<a href="<?= site_url('admincontrol/scheme_set/all_scheme_list') ?>" class="btn btn-danger">Cancel</a>
							</div>
						</div>
...
<script type="text/javascript">
	...
	function gotoclclickbutton() {
		...
		// else
		// {
		// 	if(!sc_amount.match(onlynumerics_withdot))
		// 	{
		// 		e_error = 1;
		// 		$('.sc_amount').html('Only numbers & dot allwoed, Check again.');
		// 	}
		// 	else
		// 	{
		// 		$('.sc_amount').html('');
				...
				$.ajax({
					...
					success: function(data) {
						...
						if (data.msg == 1) {
							...
							//alert(data.msg[0].space_rate);
							$('.div_roller_total').fadeOut();
							$('.get_success_total').html('Scheme is Uploaded Successfully.');
