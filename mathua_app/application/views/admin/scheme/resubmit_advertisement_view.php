...
.box-body textarea,input {max-width: 900px;}
...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Resubmission Application agasint Advertisement
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Resubmission Application agasint Advertisement</li>
          </ol>
        </section>
		    ...
		    <?php $this->session->unset_userdata('e_error'); } ?>
              ...
              <div class="box box-warning">
				...
				<div class="col-sm-offset-2 col-sm-8">
					<div class="form-group">
				  	<label class="control-label">Reason of Resubmission</label>
				    <input type="text" class="form-control" name="reson_set" id="reson_set" placeholder="Enter Reason of Resubmission" autocomplete="off" />
				    <small class="text-error reson_set"><?php echo form_error('reson_set'); ?></small>
				    </div>
				</div>
				<div class="clearfix"></div>
