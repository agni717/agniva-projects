      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <?php if($utype == 1 || $utype == 4 || $this->session->userdata['uid'] == 37) 
            { ?>
            <li class="treeview">
              <a href="#">
              ...
              <?php } 
                ...
                <li><a href="<?= site_url('admincontrol/dashboard/marksentry_datewise_total_segrigation') ?>"><i class="fa fa-circle-o text-warning"></i>Datewise Marks Entry Monitor</a></li>
                ...
                <li><a href="<?= site_url('admincontrol/dashboard/freechecking_data_asper_advertisement') ?>"><i class="fa fa-circle-o text-warning"></i>CleanUp Checking</a></li>
                <?php } ?>
              </ul>
            </li>
            <?php }
            $userlistset = array(25,27,151,154);
            ...
            <?php if($utype == 1 || $utype == 3){ ?>
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="<?= site_url('admincontrol/candidates/comp_pagewise_application_list'); ?>"><i class="fa fa-circle-o text-warning"></i> Pagewise Application List</a></li>
                <li><a href="<?= site_url('admincontrol/dashboard/categorywise_candidate_section'); ?>"><i class="fa fa-circle-o text-warning"></i> Category wise Candidate List</a></li>
                <!--<li><a href="<?php //echo site_url('admincontrol/candidates/final_approval_list'); ?>"><i class="fa fa-circle-o text-warning"></i> Approval List</a></li>
                <li><a href="<?php //echo site_url('admincontrol/candidates/admit_card_issued_list'); ?>"><i class="fa fa-circle-o text-warning"></i> AdmitCard List</a></li>
                <li><a href="<?php //echo site_url('admincontrol/candidates/final_for_empanel_list'); ?>"><i class="fa fa-circle-o text-warning"></i> Complition List</a></li>-->
                <?php //}elseif($utype == 2){ ?>
                <!--<li><a href="<?php //echo site_url('admincontrol/candidates/candidate_app_list'); ?>"><i class="fa fa-circle-o text-warning"></i> Application List</a></li>
                <li><a href="<?php //echo site_url('admincontrol/candidates/candidate_skipped_list'); ?>"><i class="fa fa-circle-o text-warning"></i> Skip Application List</a></li>-->
                <?php }elseif($utype == 3){ ?>
                <li><a href="<?php echo site_url('admincontrol/candidates/candidate_approve_list'); ?>"><i class="fa fa-circle-o text-warning"></i> Approve List</a></li>
                <li><a href="<?php echo site_url('admincontrol/candidates/candidate_approve_skip_list'); ?>"><i class="fa fa-circle-o text-warning"></i> Approve Skip List</a></li>
                <li><a href="<?php echo site_url('admincontrol/candidates/candidate_approve_return_list'); ?>"><i class="fa fa-circle-o text-warning"></i> Approve Return List</a></li>
                <li><a href="<?php echo site_url('admincontrol/candidates/candidate_reject_list'); ?>"><i class="fa fa-circle-o text-warning"></i> Reject List</a></li>
                <li><a href="<?php echo site_url('admincontrol/candidates/candidate_reject_skip_list'); ?>"><i class="fa fa-circle-o text-warning"></i> Reject Skip List</a></li>
                <li><a href="<?php echo site_url('admincontrol/candidates/candidate_reject_return_list'); ?>"><i class="fa fa-circle-o text-warning"></i> Reject Return List</a></li>
                <li><a href="<?php echo site_url('admincontrol/candidates/candidate_doubtful_list'); ?>"><i class="fa fa-circle-o text-warning"></i> Doubtful List</a></li>
                <li><a href="<?php echo site_url('admincontrol/candidates/candidate_doubtful_skip_list'); ?>"><i class="fa fa-circle-o text-warning"></i> Doubtful Skip List</a></li>
                <li><a href="<?php echo site_url('admincontrol/candidates/candidate_doubtful_return_list'); ?>"><i class="fa fa-circle-o text-warning"></i> Doubtful Return List</a></li>
                <?php } ?>
              </ul>
            </li>
            <?php } ?>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo site_url('admincontrol/checker_set/mobile_no_verify'); ?>"><i class="fa fa-circle-o text-warning"></i> Application List</a></li>
                <li><a href="<?php echo site_url('admincontrol/checker_set/candi_chk3_skipped_list'); ?>"><i class="fa fa-circle-o text-warning"></i> Skip Application List</a></li>
                <!--<li><a href="<?php //echo site_url('admincontrol/checker_set/candidate_returned_list'); ?>"><i class="fa fa-circle-o text-warning"></i> Return Application List</a></li>-->
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="<?= site_url('admincontrol/dashboard/after_finalprocess_pagewise_candidatestatus_list') ?>"><i class="fa fa-circle-o text-warning"></i> FinalProcess Pagewise List</a></li>
                ...
                <li><a href="<?= site_url('admincontrol/interview/addmore_candidates_forexisting') ?>"><i class="fa fa-circle-o text-warning"></i> Add Candidate InterView Panel</a></li>
                ...
                <li><a href="<?= site_url('admincontrol/application_set/interview_details_candidate') ?>"><i class="fa fa-circle-o text-warning"></i> Candidate Interview Details</a></li>
              </ul>
            </li>
            <?php } ?>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
              <li><a href="<?= site_url('admincontrol/finalpanel/finalcandidate_marit_list') ?>"><i class="fa fa-circle-o text-warning"></i>Candidate Merit List</a></li>  
              <li><a href="<?= site_url('admincontrol/finalpanel/generate_candidate_maritlist') ?>"><i class="fa fa-circle-o text-warning"></i>Generate Merit List</a></li>
              <li><a href="<?= site_url('admincontrol/finalpanel/final_panelled_list') ?>"><i class="fa fa-circle-o text-warning"></i>Candidate Final Panel List</a></li>
              <li><a href="<?= site_url('admincontrol/finalpanel/generate_finalpanel_candidate') ?>"><i class="fa fa-circle-o text-warning"></i>Generate Panel List</a></li>
              <li><a href="<?= site_url('admincontrol/finalpanel/combinepanel_list_for_advertisement') ?>"><i class="fa fa-circle-o text-warning"></i>Combine Panel List</a></li>
              <li><a href="<?= site_url('admincontrol/finalpanel/modification_of_meritpanel_sections') ?>"><i class="fa fa-circle-o text-warning"></i>Erase Merit & Panel List</a></li>
              </ul>
            </li>
            <?php } ?>
			<!--<li class="treeview">
